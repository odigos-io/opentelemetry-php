...
Generate binary files (opentelemetry.so) & Composer dependencies for all PHP versions:
...
The following libraries are incompatible and cannot be used with PHP 8.1:
