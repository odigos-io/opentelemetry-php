...
class CacheTokenRepository implements \Illuminate\Auth\Passwords\TokenRepositoryInterface
{
    /**
     ...
     */
    public function __construct(protected Repository $cache, protected HasherContract $hasher, protected string $hashKey, protected int $expires = 3600, protected int $throttle = 60)
    {
    }
    /**
     * Create a new token.
    ...
    public function create(CanResetPasswordContract $user)
    {
        ...
        $this->cache->put($this->cacheKey($user), [$this->hasher->make($token), Carbon::now()->format($this->format)], $this->expires);
        return $token;
    }
    /**
    ...
    protected function tokenRecentlyCreated($createdAt)
    {
        ...
        return Carbon::createFromFormat($this->format, $createdAt)->addSeconds($this->throttle)->isFuture();
    }
    /**
