...
class Task extends \Laravel\Prompts\Prompt
{
     ...
     */
    public function __construct(public string $label = '', public int $limit = 10, public bool $keepSummary = \false, public ?string $subLabel = null)
    {
     ...
     * Reset the terminal.
     */
    protected function resetTerminal(bool $originalAsync, bool $success = \true): void
    {
        $this->finished = \true;
