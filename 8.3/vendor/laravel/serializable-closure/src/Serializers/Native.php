...
class Native implements Serializable
{
    ...
    public function __unserialize($data)
    {
        ...
        if (!empty($this->code['objects'])) {
            foreach ($this->code['objects'] as $item) {
                static::setPropertyValue($item['property'], $item['instance'], $item['object'] instanceof SerializableClosure || $item['object'] instanceof UnsignedSerializableClosure ? $item['object'] : $item['object']->getClosure());
            }
        }
    ...
    {
        return \PHP_VERSION_ID >= 80400 ? $property->getRawValue($object) : $property->getValue($object);
    }
    /**
    ...
    {
        \PHP_VERSION_ID >= 80400 ? $property->setRawValue($object, $value) : $property->setValue($object, $value);
    }
    /**
