...
final class CreateResponseChoiceImage implements ResponseContract
{
     ...
     */
    private function __construct(public readonly array $imageUrl, public readonly int $index, public readonly string $type)
    {
    }
    /**
    ...
    {
        return new self(imageUrl: $attributes['image_url'], index: $attributes['index'], type: $attributes['type']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['image_url' => $this->imageUrl, 'index' => $this->index, 'type' => $this->type];
    }
}
