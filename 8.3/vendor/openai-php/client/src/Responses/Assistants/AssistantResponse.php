...
final class AssistantResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     */
    private function __construct(public string $id, public string $object, public int $createdAt, public ?string $name, public ?string $reasoningEffort, public ?string $description, public string $model, public ?string $instructions, public array $tools, public ?\OpenAI\Responses\Assistants\AssistantResponseToolResources $toolResources, public array $metadata, public ?float $temperature, public ?float $topP, public string|\OpenAI\Responses\Assistants\AssistantResponseResponseFormat $responseFormat, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    {
        $response = ['id' => $this->id, 'object' => $this->object, 'created_at' => $this->createdAt, 'name' => $this->name, 'reasoning_effort' => $this->reasoningEffort, 'description' => $this->description, 'model' => $this->model, 'instructions' => $this->instructions, 'tools' => array_map(fn(\OpenAI\Responses\Assistants\AssistantResponseToolCodeInterpreter|\OpenAI\Responses\Assistants\AssistantResponseToolFileSearch|\OpenAI\Responses\Assistants\AssistantResponseToolFunction $tool): array => $tool->toArray(), $this->tools), 'tool_resources' => $this->toolResources?->toArray(), 'metadata' => $this->metadata, 'temperature' => $this->temperature, 'top_p' => $this->topP, 'response_format' => is_string($this->responseFormat) ? $this->responseFormat : $this->responseFormat->toArray()];
