...
final class TranscriptTextDelta implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        return ['logprobs' => $this->logprobs ? array_map(fn(\OpenAI\Responses\Audio\Streaming\Logprobs $logprob): array => $logprob->toArray(), $this->logprobs) : null, 'delta' => $this->delta];
    }
}
