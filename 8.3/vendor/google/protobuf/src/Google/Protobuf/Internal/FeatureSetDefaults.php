 ...
 */
class FeatureSetDefaults extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\Internal\FeatureSetDefaults\FeatureSetEditionDefault::class);
        $this->defaults = $arr;
        return $this;
    }
    /**
