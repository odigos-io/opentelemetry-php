...
abstract class ContainerEvent implements StoppableEventInterface
{
    ...
    public function __construct(protected string $id, protected ?DefinitionInterface $definition = null, protected array $tags = [], protected mixed $resolved = null)
    {
    }
    ...
    {
        return in_array($tag, $this->tags, \true);
    }
