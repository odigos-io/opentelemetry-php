...
use Odigos\League\Container\Container;
...
// Example interfaces and classes
\class_alias('Odigos\LoggerInterface', 'LoggerInterface', \false);
...
\class_alias('Odigos\Logger', 'Logger', \false);
...
\class_alias('Odigos\UserInterface', 'UserInterface', \false);
...
\class_alias('Odigos\User', 'User', \false);
...
\class_alias('Odigos\AdminUser', 'AdminUser', \false);
...
// This won't trigger the logging listener
echo "\n4. Custom Filtering\n";
echo "-------------------\n";
...
$container->listen(ServiceResolvedEvent::class, function (ServiceResolvedEvent $event) {
    ...
    if ($event->getResolved() instanceof AdminUser) {
        $event->getResolved()->setAdmin(\true);
    }
