...
use Odigos\OpenTelemetry\Config\SDK\Configuration as SdkConfiguration;
use Odigos\OpenTelemetry\Config\SDK\Instrumentation as SdkInstrumentation;
...
class SdkAutoloader
{
    ...
    private static function environmentBasedInitializer(Configurator $configurator): Configurator
    {
        ...
        if (\OpenTelemetry\SDK\Sdk::isDisabled()) {
        ...
        $tracerProvider = (new TracerProviderBuilder())->addSpanProcessor($spanProcessor)->setResource($resource)->setSampler((new SamplerFactory())->create())->build();
