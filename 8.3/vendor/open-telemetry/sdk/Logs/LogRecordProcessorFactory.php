...
{
    public function create(\OpenTelemetry\SDK\Logs\LogRecordExporterInterface $exporter, ?MeterProviderInterface $meterProvider = null): \OpenTelemetry\SDK\Logs\LogRecordProcessorInterface
    {
        $processors = [];
    ...
    private function createProcessor(string $name, \OpenTelemetry\SDK\Logs\LogRecordExporterInterface $exporter, ?MeterProviderInterface $meterProvider = null): \OpenTelemetry\SDK\Logs\LogRecordProcessorInterface
    {
        return match ($name) {
