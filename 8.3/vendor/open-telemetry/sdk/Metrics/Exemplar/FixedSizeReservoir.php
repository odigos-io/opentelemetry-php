...
final class FixedSizeReservoir implements \OpenTelemetry\SDK\Metrics\Exemplar\ExemplarReservoirInterface
{
    ...
    {
        $this->storage = new \OpenTelemetry\SDK\Metrics\Exemplar\BucketStorage($size);
        $this->size = $size;
    }
    #[\Override]
