...
class Command implements LaravelHook
{
    ...
    {
        return hook(IlluminateCommand::class, 'execute', pre: function (IlluminateCommand $command, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
