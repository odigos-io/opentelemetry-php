...
namespace Odigos\Opentelemetry\Proto\Logs\V1;
 ...
 */
class LogRecord extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Odigos\GPBMetadata\Opentelemetry\Proto\Logs\V1\Logs::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Opentelemetry\Proto\Logs\V1\SeverityNumber::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Common\V1\AnyValue::class);
        $this->body = $var;
        return $this;
    }
    /**
