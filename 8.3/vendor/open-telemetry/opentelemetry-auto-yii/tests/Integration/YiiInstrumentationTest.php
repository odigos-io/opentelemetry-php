...
class YiiInstrumentationTest extends \OpenTelemetry\Tests\Instrumentation\Yii\tests\Integration\AbstractTest
{
    ...
    private function runRequest($path)
    {
        ...
        ], 'cache' => ['class' => 'yii\caching\FileCache'], 'user' => ['identityClass' => 'Odigos\app\models\User', 'enableAutoLogin' => \true], 'errorHandler' => ['errorAction' => 'site/error'], 'log' => ['traceLevel' => 3, 'targets' => [['class' => 'yii\log\FileTarget', 'levels' => ['error', 'warning']]]], 'db' => ['class' => 'yii\db\Connection', 'dsn' => 'mysql:host=localhost;dbname=yii2basic', 'username' => 'root', 'password' => '', 'charset' => 'utf8'], 'urlManager' => ['enablePrettyUrl' => \true, 'showScriptName' => \false, 'rules' => ['<controller:\w+>' => '<controller>', '<controller:\w+>/<action:\w+>' => '<controller>/<action>']]], 'controllerMap' => ['site' => ['class' => 'OpenTelemetry\Tests\Instrumentation\Yii\tests\Integration\SiteController']], 'params' => []];
...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $config = ['class' => 'yii\web\Response', 'format' => \yii\web\Response::FORMAT_RAW, 'content' => 'hello'];
