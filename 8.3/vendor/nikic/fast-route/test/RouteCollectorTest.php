...
class RouteCollectorTest extends TestCase
{
    public function testShortcuts()
    {
        ...
        $r->post('/post', 'post');
        $r->put('/put', 'put');
        $expected = [['DELETE', '/delete', 'delete'], ['GET', '/get', 'get'], ['HEAD', '/head', 'head'], ['PATCH', '/patch', 'patch'], ['POST', '/post', 'post'], ['PUT', '/put', 'put']];
