 ...
 */
use Odigos\Symfony\Polyfill\Mbstring as p;
if (!\function_exists('mb_convert_encoding') && !\function_exists('Odigos\mb_convert_encoding')) {
...
if (!\function_exists('mb_decode_mimeheader') && !\function_exists('Odigos\mb_decode_mimeheader')) {
    function mb_decode_mimeheader($string)
    {
        return p\Mbstring::mb_decode_mimeheader($string);
    }
}
if (!\function_exists('mb_encode_mimeheader') && !\function_exists('Odigos\mb_encode_mimeheader')) {
    function mb_encode_mimeheader($string, $charset = null, $transfer_encoding = null, $newline = "\r\n", $indent = 0)
    {
        return p\Mbstring::mb_encode_mimeheader($string, $charset, $transfer_encoding, $newline, $indent);
    }
}
if (!\function_exists('mb_decode_numericentity') && !\function_exists('Odigos\mb_decode_numericentity')) {
    function mb_decode_numericentity($string, $map, $encoding = null)
    {
        return p\Mbstring::mb_decode_numericentity($string, $map, $encoding);
    }
}
if (!\function_exists('mb_encode_numericentity') && !\function_exists('Odigos\mb_encode_numericentity')) {
...
if (!\function_exists('mb_convert_case') && !\function_exists('Odigos\mb_convert_case')) {
    function mb_convert_case($string, $mode, $encoding = null)
    {
        return p\Mbstring::mb_convert_case($string, $mode, $encoding);
    }
}
if (!\function_exists('mb_internal_encoding') && !\function_exists('Odigos\mb_internal_encoding')) {
    function mb_internal_encoding($encoding = null)
    {
        return p\Mbstring::mb_internal_encoding($encoding);
    }
}
if (!\function_exists('mb_language') && !\function_exists('Odigos\mb_language')) {
    function mb_language($language = null)
    {
        return p\Mbstring::mb_language($language);
    }
}
if (!\function_exists('mb_list_encodings') && !\function_exists('Odigos\mb_list_encodings')) {
    function mb_list_encodings()
    {
        return p\Mbstring::mb_list_encodings();
    }
}
if (!\function_exists('mb_encoding_aliases') && !\function_exists('Odigos\mb_encoding_aliases')) {
    function mb_encoding_aliases($encoding)
    {
        return p\Mbstring::mb_encoding_aliases($encoding);
    }
}
if (!\function_exists('mb_check_encoding') && !\function_exists('Odigos\mb_check_encoding')) {
    function mb_check_encoding($value = null, $encoding = null)
    {
        return p\Mbstring::mb_check_encoding($value, $encoding);
    }
}
if (!\function_exists('mb_detect_encoding') && !\function_exists('Odigos\mb_detect_encoding')) {
...
if (!\function_exists('mb_detect_order') && !\function_exists('Odigos\mb_detect_order')) {
    function mb_detect_order($encoding = null)
    {
        return p\Mbstring::mb_detect_order($encoding);
    }
}
if (!\function_exists('mb_parse_str') && !\function_exists('Odigos\mb_parse_str')) {
...
if (!\function_exists('mb_strrchr') && !\function_exists('Odigos\mb_strrchr')) {
...
if (!\function_exists('mb_strrichr') && !\function_exists('Odigos\mb_strrichr')) {
...
if (!\function_exists('mb_strripos') && !\function_exists('Odigos\mb_strripos')) {
    function mb_strripos($haystack, $needle, $offset = 0, $encoding = null)
    {
        return p\Mbstring::mb_strripos($haystack, $needle, $offset, $encoding);
    }
}
if (!\function_exists('mb_strrpos') && !\function_exists('Odigos\mb_strrpos')) {
    function mb_strrpos($haystack, $needle, $offset = 0, $encoding = null)
    {
        return p\Mbstring::mb_strrpos($haystack, $needle, $offset, $encoding);
    }
}
if (!\function_exists('mb_strstr') && !\function_exists('Odigos\mb_strstr')) {
