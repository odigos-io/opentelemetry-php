...
class HtmlErrorRenderer implements \Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
    ...
    private \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter $fileLinkFormat;
     ...
     */
    public function __construct(bool|callable $debug = \false, ?string $charset = null, string|\Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter|null $fileLinkFormat = null, private ?string $projectDir = null, string|callable $outputBuffer = '', private ?LoggerInterface $logger = null)
    {
        $this->debug = \is_bool($debug) ? $debug : $debug(...);
        $this->charset = $charset ?: (\ini_get('default_charset') ?: 'UTF-8');
        $this->fileLinkFormat = $fileLinkFormat instanceof \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter ? $fileLinkFormat : new \Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter($fileLinkFormat);
