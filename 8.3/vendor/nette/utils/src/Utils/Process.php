...
final class Process
{
     ...
     */
    public static function runExecutable(string $executable, array $arguments = [], ?array $env = null, array $options = [], mixed $stdin = '', mixed $stdout = null, mixed $stderr = null, ?string $directory = null, ?float $timeout = self::DefaultTimeout): self
    {
     ...
     * @param  float|null     $timeout    Time limit in seconds, checked while waiting for or reading the process; null disables it.
     */
    public static function runCommand(string $command, ?array $env = null, array $options = [], mixed $stdin = '', mixed $stdout = null, mixed $stderr = null, ?string $directory = null, ?float $timeout = self::DefaultTimeout): self
    {
     ...
     */
    private function __construct(string|array $command, ?array $env, array $options, ?string $directory, mixed $stdin, mixed $stdout, mixed $stderr, private readonly ?float $timeout)
    {
