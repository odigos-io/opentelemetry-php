...
final class Process
{
     ...
     */
    private function __construct(string|array $command, ?array $env, array $options, ?string $directory, mixed $stdin, mixed $stdout, mixed $stderr, private ?float $timeout)
    {
