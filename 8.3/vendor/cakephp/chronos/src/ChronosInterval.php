...
class ChronosInterval implements Stringable
{
     ...
     * @return static
     */
    public static function createFromValues(?int $years = null, ?int $months = null, ?int $weeks = null, ?int $days = null, ?int $hours = null, ?int $minutes = null, ?int $seconds = null, ?int $microseconds = null): static
    {
        $interval = Chronos::createInterval($years, $months, $weeks, $days, $hours, $minutes, $seconds, $microseconds);
    ...
    {
        return $this->interval->y === 0 && $this->interval->m === 0 && $this->interval->d === 0 && $this->interval->h === 0 && $this->interval->i === 0 && $this->interval->s === 0 && $this->interval->f === 0.0;
    }
    /**
    ...
    {
        return ['interval' => $this->toIso8601String(), 'years' => $this->interval->y, 'months' => $this->interval->m, 'days' => $this->interval->d, 'hours' => $this->interval->h, 'minutes' => $this->interval->i, 'seconds' => $this->interval->s, 'microseconds' => $this->interval->f, 'invert' => $this->interval->invert];
    }
}
