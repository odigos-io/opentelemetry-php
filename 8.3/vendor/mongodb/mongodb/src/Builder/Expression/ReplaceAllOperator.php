...
final class ReplaceAllOperator implements ResolvesToString, OperatorInterface
{
     ...
     */
    public function __construct(ResolvesToNull|ResolvesToString|null|string $input, Regex|ResolvesToNull|ResolvesToRegex|ResolvesToString|null|string $find, ResolvesToNull|ResolvesToString|null|string $replacement)
    {
        $this->input = $input;
        $this->find = $find;
