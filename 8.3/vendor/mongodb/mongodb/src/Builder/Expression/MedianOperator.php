 ...
 * @internal
 */
final class MedianOperator implements \MongoDB\Builder\Expression\ResolvesToDouble, OperatorInterface
{
     ...
     */
    public function __construct(Decimal128|Int64|PackedArray|\MongoDB\Builder\Expression\ResolvesToNumber|BSONArray|array|float|int|string $input, string $method)
    {
