 ...
 * @internal
 */
final class StrLenBytesOperator implements \MongoDB\Builder\Expression\ResolvesToInt, OperatorInterface
{
    public const ENCODE = Encode::Single;
    public const NAME = '$strLenBytes';
    public const PROPERTIES = ['expression' => 'expression'];
    /** @var ResolvesToString|string $expression */
    public readonly \MongoDB\Builder\Expression\ResolvesToString|string $expression;
    /**
