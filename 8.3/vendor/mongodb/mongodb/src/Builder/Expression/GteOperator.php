 ...
 * @internal
 */
final class GteOperator implements \MongoDB\Builder\Expression\ResolvesToBool, OperatorInterface
{
     ...
     */
    public function __construct(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2)
    {
