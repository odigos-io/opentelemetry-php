 ...
 * @internal
 */
final class BsonSizeOperator implements \MongoDB\Builder\Expression\ResolvesToInt, OperatorInterface
{
    ...
    public readonly Document|Serializable|\MongoDB\Builder\Expression\ResolvesToNull|\MongoDB\Builder\Expression\ResolvesToObject|stdClass|array|null|string $object;
    /**
     * @param Document|ResolvesToNull|ResolvesToObject|Serializable|array|null|stdClass|string $object
     */
    public function __construct(Document|Serializable|\MongoDB\Builder\Expression\ResolvesToNull|\MongoDB\Builder\Expression\ResolvesToObject|stdClass|array|null|string $object)
    {
