...
final class ReduceOperator implements ResolvesToAny, OperatorInterface
{
    ...
    public const PROPERTIES = ['input' => 'input', 'initialValue' => 'initialValue', 'in' => 'in', 'as' => 'as', 'valueAs' => 'valueAs', 'arrayIndexAs' => 'arrayIndexAs'];
    /**
     ...
     * New in MongoDB 8.3
     */
    public function __construct(PackedArray|ResolvesToArray|BSONArray|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $initialValue, DateTimeInterface|Document|Serializable|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in, Optional|string $as = Optional::Undefined, Optional|string $valueAs = Optional::Undefined, Optional|string $arrayIndexAs = Optional::Undefined)
    {
