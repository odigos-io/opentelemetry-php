 ...
 * @internal
 */
final class DateDiffOperator implements \MongoDB\Builder\Expression\ResolvesToInt, OperatorInterface
{
    public const ENCODE = Encode::Object;
    public const NAME = '$dateDiff';
    public const PROPERTIES = ['startDate' => 'startDate', 'endDate' => 'endDate', 'unit' => 'unit', 'timezone' => 'timezone', 'startOfWeek' => 'startOfWeek'];
    ...
    public readonly DateTimeInterface|ObjectId|Timestamp|UTCDateTime|\MongoDB\Builder\Expression\ResolvesToDate|\MongoDB\Builder\Expression\ResolvesToObjectId|\MongoDB\Builder\Expression\ResolvesToTimestamp|int|string $startDate;
    ...
    public readonly DateTimeInterface|ObjectId|Timestamp|UTCDateTime|\MongoDB\Builder\Expression\ResolvesToDate|\MongoDB\Builder\Expression\ResolvesToObjectId|\MongoDB\Builder\Expression\ResolvesToTimestamp|int|string $endDate;
    /** @var ResolvesToString|TimeUnit|string $unit The time measurement unit between the startDate and endDate */
    public readonly \MongoDB\Builder\Expression\ResolvesToString|TimeUnit|string $unit;
    ...
    public readonly Optional|\MongoDB\Builder\Expression\ResolvesToString|string $startOfWeek;
    /**
