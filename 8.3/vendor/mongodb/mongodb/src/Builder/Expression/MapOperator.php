...
final class MapOperator implements ResolvesToArray, OperatorInterface
{
     ...
     * New in MongoDB 8.3
     */
    public function __construct(PackedArray|ResolvesToArray|BSONArray|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in, Optional|string $as = Optional::Undefined, Optional|string $arrayIndexAs = Optional::Undefined)
    {
