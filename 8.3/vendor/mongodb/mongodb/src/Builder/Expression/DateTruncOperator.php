 ...
 * @internal
 */
final class DateTruncOperator implements \MongoDB\Builder\Expression\ResolvesToDate, OperatorInterface
{
    public const ENCODE = Encode::Object;
    public const NAME = '$dateTrunc';
    public const PROPERTIES = ['date' => 'date', 'unit' => 'unit', 'binSize' => 'binSize', 'timezone' => 'timezone', 'startOfWeek' => 'startOfWeek'];
    ...
    public readonly DateTimeInterface|ObjectId|Timestamp|UTCDateTime|\MongoDB\Builder\Expression\ResolvesToDate|\MongoDB\Builder\Expression\ResolvesToObjectId|\MongoDB\Builder\Expression\ResolvesToTimestamp|int|string $date;
    /**
     ...
     * Together, binSize and unit specify the time period used in the $dateTrunc calculation.
     */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $binSize;
