 ...
 * @internal
 */
final class ExpOperator implements \MongoDB\Builder\Expression\ResolvesToDouble, OperatorInterface
{
     ...
     */
    public function __construct(Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $exponent)
    {
