 ...
 * @internal
 */
final class LogOperator implements \MongoDB\Builder\Expression\ResolvesToDouble, OperatorInterface
{
    ...
    public readonly Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $base;
    /**
     ...
     */
    public function __construct(Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $number, Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $base)
    {
