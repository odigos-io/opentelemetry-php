 ...
 * @internal
 */
final class Atan2Operator implements \MongoDB\Builder\Expression\ResolvesToDouble, \MongoDB\Builder\Expression\ResolvesToDecimal, OperatorInterface
{
     ...
     */
    public readonly Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $y;
    /** @var Decimal128|Int64|ResolvesToNumber|float|int|string $x */
    public readonly Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $x;
    /**
     ...
     */
    public function __construct(Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $y, Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $x)
    {
