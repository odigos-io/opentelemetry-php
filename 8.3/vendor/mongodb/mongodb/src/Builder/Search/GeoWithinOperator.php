...
final class GeoWithinOperator implements SearchOperatorInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['path' => 'path', 'box' => 'box', 'circle' => 'circle', 'geometry' => 'geometry', 'score' => 'score'];
     ...
     */
    public function __construct(array|string $path, Optional|Document|Serializable|stdClass|array $box = Optional::Undefined, Optional|Document|Serializable|stdClass|array $circle = Optional::Undefined, Optional|Document|Serializable|GeometryInterface|stdClass|array $geometry = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined)
    {
        $this->path = $path;
        $this->box = $box;
        $this->circle = $circle;
