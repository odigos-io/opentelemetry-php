...
final class EqualsOperator implements SearchOperatorInterface, OperatorInterface
{
     ...
     */
    public function __construct(array|string $path, DateTimeInterface|Binary|Decimal128|Int64|ObjectId|UTCDateTime|bool|float|int|null|string $value, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined, Optional|PackedArray|BSONArray|array|string $doesNotAffect = Optional::Undefined)
    {
        $this->path = $path;
        $this->value = $value;
        $this->score = $score;
