...
final class AutocompleteOperator implements SearchOperatorInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['path' => 'path', 'query' => 'query', 'tokenOrder' => 'tokenOrder', 'fuzzy' => 'fuzzy', 'score' => 'score'];
     ...
     */
    public function __construct(array|string $path, string $query, Optional|string $tokenOrder = Optional::Undefined, Optional|Document|Serializable|stdClass|array $fuzzy = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined)
    {
        $this->path = $path;
        $this->query = $query;
