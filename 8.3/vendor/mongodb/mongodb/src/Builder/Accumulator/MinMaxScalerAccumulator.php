...
final class MinMaxScalerAccumulator implements WindowInterface, OperatorInterface
{
     ...
     */
    public function __construct(Decimal128|Int64|ResolvesToNumber|float|int|string $input, Optional|Decimal128|Int64|float|int $min = Optional::Undefined, Optional|Decimal128|Int64|float|int $max = Optional::Undefined)
    {
