...
final class AccumulatorAccumulator implements AccumulatorInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['init' => 'init', 'accumulate' => 'accumulate', 'accumulateArgs' => 'accumulateArgs', 'merge' => 'merge', 'lang' => 'lang', 'initArgs' => 'initArgs', 'finalize' => 'finalize'];
     ...
     */
    public function __construct(Javascript|string $init, Javascript|string $accumulate, PackedArray|ResolvesToArray|BSONArray|array|string $accumulateArgs, Javascript|string $merge, string $lang, Optional|PackedArray|ResolvesToArray|BSONArray|array|string $initArgs = Optional::Undefined, Optional|Javascript|string $finalize = Optional::Undefined)
    {
        if (is_string($init)) {
