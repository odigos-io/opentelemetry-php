...
final class PercentileAccumulator implements AccumulatorInterface, WindowInterface, OperatorInterface
{
     ...
     */
    public function __construct(Decimal128|Int64|ResolvesToNumber|float|int|string $input, PackedArray|ResolvesToArray|BSONArray|array|string $p, string $method)
    {
