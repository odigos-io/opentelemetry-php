...
final class ScoreStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['score' => 'score', 'normalization' => 'normalization', 'weight' => 'weight', 'scoreDetails' => 'scoreDetails'];
    /**
     ...
     * output document.
     */
    public function __construct(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $score, Optional|string $normalization = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $weight = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined)
    {
        $this->score = $score;
