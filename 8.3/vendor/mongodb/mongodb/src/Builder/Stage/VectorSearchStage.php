...
final class VectorSearchStage implements InputStageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['index' => 'index', 'limit' => 'limit', 'path' => 'path', 'queryVector' => 'queryVector', 'exact' => 'exact', 'filter' => 'filter', 'numCandidates' => 'numCandidates', 'returnStoredSource' => 'returnStoredSource', 'nestedOptions' => 'nestedOptions', 'parentFilter' => 'parentFilter', 'query' => 'query', 'model' => 'model'];
