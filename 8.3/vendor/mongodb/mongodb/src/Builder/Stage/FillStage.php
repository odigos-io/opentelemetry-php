...
final class FillStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['output' => 'output', 'partitionBy' => 'partitionBy', 'partitionByFields' => 'partitionByFields', 'sortBy' => 'sortBy'];
    /**
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $output, Optional|Document|Serializable|stdClass|array|string $partitionBy = Optional::Undefined, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sortBy = Optional::Undefined)
    {
        $this->output = $output;
