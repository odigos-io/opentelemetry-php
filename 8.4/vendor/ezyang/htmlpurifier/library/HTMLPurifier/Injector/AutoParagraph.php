    ...
    public function handleText(&$token)
    {
        ...
        if ($this->allowsElement('p')) {
            if (empty($this->currentNesting) || \strpos($text, "\n\n") !== \false) {
                ...
                } else if (!$token->is_whitespace || $this->_isInline($current)) {
                    // State 1.2: PAR1
                    //            ----
                    // State 1.3: PAR1\n\nPAR2
                    //            ------------
 ...
 * @todo Make a graph of the flow control for this Injector.
 */
\class_alias('Odigos\HTMLPurifier_Injector_AutoParagraph', 'HTMLPurifier_Injector_AutoParagraph', \false);
// vim: et sw=4 sts=4
