...
use Odigos\Monolog\Handler\FingersCrossedHandler;
use Odigos\Monolog\Handler\FormattableHandlerInterface;
use Odigos\Monolog\Handler\HandlerInterface;
use Odigos\Monolog\Handler\RotatingFileHandler;
use Odigos\Monolog\Handler\SlackWebhookHandler;
use Odigos\Monolog\Handler\StreamHandler;
use Odigos\Monolog\Handler\SyslogHandler;
use Odigos\Monolog\Handler\WhatFailureGroupHandler;
use Odigos\Monolog\Logger as Monolog;
...
class LogManager implements LoggerInterface
{
    ...
    protected function createMonologDriver(array $config)
    {
        ...
        $processors = (new Collection($config['processors'] ?? []))->map(fn($processor) => $this->app->make($processor['processor'] ?? $processor, $processor['with'] ?? []))->toArray();
