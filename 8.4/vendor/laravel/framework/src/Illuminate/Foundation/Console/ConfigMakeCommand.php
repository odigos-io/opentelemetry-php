...
class ConfigMakeCommand extends GeneratorCommand
{
    ...
    protected function getStub(): string
    {
        ...
        return file_exists($customPath = $this->laravel->basePath($relativePath)) ? $customPath : join_paths(__DIR__, $relativePath);
    }
    /**
    ...
    {
        return [['force', 'f', InputOption::VALUE_NONE, 'Create the configuration file even if it already exists']];
    }
    /**
