...
class Middleware
{
     ...
     * @return $this
     */
    public function trustHosts(array|callable|null $at = null, bool $subdomains = \true)
    {
        $this->trustHosts = \true;
        if (!is_null($at)) {
    ...
    {
        $this->authenticatedSessions = \true;
        return $this;
    }
    /**
