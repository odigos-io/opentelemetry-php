...
class Mailable implements MailableContract, Renderable
{
    ...
    {
        return ['__laravel_mailable' => get_class($this)];
    }
    /**
    ...
    protected function setAddress($address, $name = null, $property = 'to')
    {
        ...
        $this->{$property} = (new Collection($this->{$property}))->reverse()->unique('address')->reverse()->values()->all();
        return $this;
    }
    /**
    ...
    public function hasAttachment($file, array $options = [])
    {
        ...
        return (new Collection($this->attachments))->contains(fn($attachment) => $attachment['file'] === $file && array_filter($attachment['options']) === array_filter($options));
    }
    /**
    ...
    private function hasEnvelopeAttachment($attachment, $options = [])
    {
        ...
        return (new Collection(is_object($attachments) ? [$attachments] : $attachments))->map(fn($attached) => $attached instanceof Attachable ? $attached->toMailAttachment() : $attached)->contains(fn($attached) => $attached->isEquivalent($attachment, $options));
    }
    /**
    ...
    {
        $this->diskAttachments = (new Collection($this->diskAttachments))->push(['disk' => $disk, 'path' => $path, 'name' => $name ?? basename($path), 'options' => $options])->unique(fn($file) => $file['name'] . $file['disk'] . $file['path'])->all();
        return $this;
    }
    /**
    ...
    {
        return (new Collection($this->diskAttachments))->contains(fn($attachment) => $attachment['disk'] === $disk && $attachment['path'] === $path && $attachment['name'] === ($name ?? basename($path)) && $attachment['options'] === $options);
    }
    /**
    ...
    {
        $this->rawAttachments = (new Collection($this->rawAttachments))->push(compact('data', 'name', 'options'))->unique(fn($file) => $file['name'] . $file['data'])->all();
        return $this;
    }
    /**
    ...
    {
        return (new Collection($this->rawAttachments))->contains(fn($attachment) => $attachment['data'] === $data && $attachment['name'] === $name && array_filter($attachment['options']) === array_filter($options));
    }
    /**
    ...
    public function assertFrom($address, $name = null)
    {
        ...
        PHPUnit::assertTrue($this->hasFrom($address, $name), "Email was not from expected address.\nExpected: [{$expected}]\nActual: [{$actual}]");
        return $this;
    }
    /**
    ...
    public function assertTo($address, $name = null)
    {
        ...
        PHPUnit::assertTrue($this->hasTo($address, $name), "Did not see expected recipient in email 'to' recipients.\nExpected: [{$expected}]\nActual: [{$actual}]");
        return $this;
    }
    /**
     * Assert that the mailable has the given recipient.
    ...
    public function assertHasCc($address, $name = null)
    {
        ...
        PHPUnit::assertTrue($this->hasCc($address, $name), "Did not see expected recipient in email 'cc' recipients.\nExpected: [{$expected}]\nActual: [{$actual}]");
        return $this;
    }
    /**
     * Assert that the mailable has the given recipient.
    ...
    public function assertHasBcc($address, $name = null)
    {
        ...
        PHPUnit::assertTrue($this->hasBcc($address, $name), "Did not see expected recipient in email 'bcc' recipients.\nExpected: [{$expected}]\nActual: [{$actual}]");
        return $this;
    }
    /**
    ...
    public function assertHasReplyTo($address, $name = null)
    {
        ...
        PHPUnit::assertTrue($this->hasReplyTo($address, $name), "Did not see expected address as email 'reply to' recipient.\nExpected: [{$expected}]\nActual: [{$actual}]");
        return $this;
    }
    /**
    ...
    public function assertHasSubject($subject)
    {
        ...
        PHPUnit::assertTrue($this->hasSubject($subject), "Email subject does not match expected value.\nExpected: [{$subject}]\nActual: [{$actualSubject}]");
        return $this;
    }
    /**
    ...
    public function assertHasTag($tag)
    {
        ...
        PHPUnit::assertTrue($this->hasTag($tag), "Did not see expected tag in email tags.\nExpected: [{$tag}]\nActual: [{$actualTagsString}]");
        return $this;
    }
    /**
    ...
    public function assertHasMetadata($key, $value)
    {
        ...
        PHPUnit::assertTrue($this->hasMetadata($key, $value), "Email metadata does not match expected value.\nExpected: [{$key}] => [{$value}]\nActual: {$actualString}");
        return $this;
    }
    /**
    ...
    private function ensureAttachmentsAreHydrated()
    {
        ...
        $attachments = $this->attachments();
        (new Collection(is_object($attachments) ? [$attachments] : $attachments))->each(function ($attachment) {
