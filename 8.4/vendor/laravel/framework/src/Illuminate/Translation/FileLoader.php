...
class FileLoader implements Loader
{
    ...
    {
        return (new Collection($this->paths))->reduce(function ($output, $path) use ($locale, $group, $namespace) {
    ...
    {
        return (new Collection($paths))->reduce(function ($output, $path) use ($locale, $group) {
    ...
    {
        return (new Collection(array_merge($this->jsonPaths, $this->paths)))->reduce(function ($output, $path) use ($locale) {
