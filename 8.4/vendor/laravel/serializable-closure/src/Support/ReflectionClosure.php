...
namespace Odigos\Laravel\SerializableClosure\Support;
...
class ReflectionClosure extends ReflectionFunction
{
    ...
    protected function collectCandidate(&$candidates, $code, $use, $isShortClosure, $isUsingThisObject, $isUsingScope)
    {
        ...
        return ['code' => '', 'state' => 'start', 'open' => 0, 'use' => [], 'isShortClosure' => \false, 'isUsingThisObject' => \false, 'isUsingScope' => \false, 'closureArgsInnerFuncCount' => 0, 'closureArgsBraceDepth' => 0];
    }
    /**
