...
class GridView extends BaseListView
{
    ...
    public function renderItems()
    {
        ...
        $content = array_filter([$caption, $columnGroup, $tableHeader, $tableFooter, $tableBody, $tableFooterAfterBody]);
