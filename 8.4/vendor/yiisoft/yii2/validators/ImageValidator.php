...
class ImageValidator extends \yii\validators\FileValidator
{
    ...
    public function getClientOptions($model, $attribute)
    {
        ...
        if ($this->notImage !== null) {
            $options['notImage'] = $this->formatMessage($this->notImage, ['attribute' => $label]);
        }
        if ($this->minWidth !== null) {
            $options['minWidth'] = $this->minWidth;
            $options['underWidth'] = $this->formatMessage($this->underWidth, ['attribute' => $label, 'limit' => $this->minWidth]);
        }
        if ($this->maxWidth !== null) {
            $options['maxWidth'] = $this->maxWidth;
            $options['overWidth'] = $this->formatMessage($this->overWidth, ['attribute' => $label, 'limit' => $this->maxWidth]);
        }
        if ($this->minHeight !== null) {
            $options['minHeight'] = $this->minHeight;
            $options['underHeight'] = $this->formatMessage($this->underHeight, ['attribute' => $label, 'limit' => $this->minHeight]);
        }
        if ($this->maxHeight !== null) {
            $options['maxHeight'] = $this->maxHeight;
            $options['overHeight'] = $this->formatMessage($this->overHeight, ['attribute' => $label, 'limit' => $this->maxHeight]);
        }
        return $options;
    }
}
