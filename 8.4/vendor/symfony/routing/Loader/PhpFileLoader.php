...
class PhpFileLoader extends FileLoader
{
    ...
    public function load(mixed $file, ?string $type = null): RouteCollection
    {
        ...
        try {
            ...
            $load = \Closure::bind(static function ($file) use ($loader) {
                return include $file;
            }, null, \Symfony\Component\Routing\Loader\ProtectedPhpFileLoader::class);
            if (1 === $result = $load($path)) {
                $result = null;
            }
        ...
        if (\is_object($result) && \is_callable($result)) {
            ...
            $loader = new \Symfony\Component\Routing\Loader\YamlFileLoader($this->locator, $this->env);
            $loader->setResolver($this->resolver ?? new LoaderResolver([$this]));
            (new \ReflectionMethod(\Symfony\Component\Routing\Loader\YamlFileLoader::class, 'loadContent'))->invoke($loader, $collection, $result, $path, $file);
 ...
 * @internal
 */
final class ProtectedPhpFileLoader extends \Symfony\Component\Routing\Loader\PhpFileLoader
{
}
