 ...
 */
use Odigos\Symfony\Polyfill\Php85 as p;
if (\PHP_VERSION_ID >= 80500) {
    return;
}
if (!\function_exists('get_error_handler') && !\function_exists('Odigos\get_error_handler')) {
    function get_error_handler(): ?callable
    {
        return p\Php85::get_error_handler();
    }
}
if (!\function_exists('get_exception_handler') && !\function_exists('Odigos\get_exception_handler')) {
    function get_exception_handler(): ?callable
    {
        return p\Php85::get_exception_handler();
    }
}
if (!\function_exists('array_first') && !\function_exists('Odigos\array_first')) {
    function array_first(array $array)
    {
        return p\Php85::array_first($array);
    }
}
if (!\function_exists('array_last') && !\function_exists('Odigos\array_last')) {
    function array_last(array $array)
    {
        return p\Php85::array_last($array);
    }
}
if (\extension_loaded('intl') && (!\function_exists('locale_is_right_to_left') && !\function_exists('Odigos\locale_is_right_to_left'))) {
