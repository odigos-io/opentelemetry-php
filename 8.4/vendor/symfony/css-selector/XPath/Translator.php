...
use Odigos\Symfony\Component\CssSelector\Node\NodeInterface;
...
class Translator implements TranslatorInterface
{
    ...
    public function __construct(?ParserInterface $parser = null)
    {
        ...
        $this->registerExtension(new Extension\NodeExtension())->registerExtension(new Extension\CombinationExtension())->registerExtension(new Extension\FunctionExtension())->registerExtension(new Extension\PseudoClassExtension())->registerExtension(new Extension\AttributeMatchingExtension())->registerExtension(new Extension\RelationExtension());
    }
