...
abstract class AbstractCloner implements \Symfony\Component\VarDumper\Cloner\ClonerInterface
{
     ...
     */
    public function cloneVar(mixed $var, int $filter = 0): \Symfony\Component\VarDumper\Cloner\Data
    {
     ...
     */
    protected function castObject(\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested): array
    {
        $obj = $stub->value;
        $class = $stub->class;
        ...
        if (isset($this->classInfo[$class])) {
            ...
            $fileInfo = $r->isInternal() || $r->isSubclassOf(\Symfony\Component\VarDumper\Cloner\Stub::class) ? [] : ['file' => $r->getFileName(), 'line' => $r->getStartLine()];
        ...
        try {
            ...
            $a = [(\Symfony\Component\VarDumper\Cloner\Stub::TYPE_OBJECT === $stub->type ? Caster::PREFIX_VIRTUAL : '') . '⚠' => new ThrowingCasterException($e)] + $a;
        }
        return $a;
    }
    /**
     ...
     * @param bool $isNested True if the object is nested in the dumped structure
     */
    protected function castResource(\Symfony\Component\VarDumper\Cloner\Stub $stub, bool $isNested): array
    {
        $a = [];
        $res = $stub->value;
        $type = $stub->class;
