...
final class CondOperator implements ResolvesToAny, OperatorInterface
{
     ...
     */
    public function __construct(ResolvesToBool|bool|string $if, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $then, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $else)
    {
