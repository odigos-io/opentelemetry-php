 ...
 * @internal
 */
final class CondOperator implements \MongoDB\Builder\Expression\ResolvesToAny, OperatorInterface
{
    public const ENCODE = Encode::Object;
    public const NAME = '$cond';
    public const PROPERTIES = ['if' => 'if', 'then' => 'then', 'else' => 'else'];
    /** @var ResolvesToBool|bool|string $if */
    public readonly \MongoDB\Builder\Expression\ResolvesToBool|bool|string $if;
     ...
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToBool|bool|string $if, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $then, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $else)
    {
