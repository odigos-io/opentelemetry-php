 ...
 * @internal
 */
final class SetFieldOperator implements \MongoDB\Builder\Expression\ResolvesToObject, OperatorInterface
{
    ...
    public readonly Document|Serializable|\MongoDB\Builder\Expression\ResolvesToObject|stdClass|array|string $input;
    /**
     ...
     * Set to $$REMOVE to remove field from the input document.
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToString|string $field, Document|Serializable|\MongoDB\Builder\Expression\ResolvesToObject|stdClass|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $value)
    {
        $this->field = $field;
