...
trait FactoryTrait
{
     ...
     */
    public static function add(DateTimeInterface|Decimal128|Int64|UTCDateTime|ResolvesToDate|ResolvesToNumber|float|int|string ...$expression): AddOperator
    {
     ...
     */
    public static function allElementsTrue(PackedArray|ResolvesToArray|BSONArray|array|string $expression): AllElementsTrueOperator
    {
     ...
     */
    public static function and(DateTimeInterface|Decimal128|Int64|Type|ResolvesToBool|ResolvesToNull|ResolvesToNumber|ResolvesToString|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): AndOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string $expression
     */
    public static function anyElementTrue(PackedArray|ResolvesToArray|BSONArray|array|string $expression): AnyElementTrueOperator
    {
     ...
     */
    public static function arrayElemAt(PackedArray|ResolvesToArray|BSONArray|array|string $array, ResolvesToInt|int|string $idx): ArrayElemAtOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string $array
     */
    public static function arrayToObject(PackedArray|ResolvesToArray|BSONArray|array|string $array): ArrayToObjectOperator
    {
     ...
     */
    public static function atan2(Decimal128|Int64|ResolvesToNumber|float|int|string $y, Decimal128|Int64|ResolvesToNumber|float|int|string $x): Atan2Operator
    {
     ...
     */
    public static function binarySize(Binary|ResolvesToBinData|ResolvesToNull|ResolvesToString|null|string $expression): BinarySizeOperator
    {
     ...
     */
    public static function bottom(Document|Serializable|stdClass|array $sortBy, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $output, PackedArray|ResolvesToArray|BSONArray|array|string $input): BottomOperator
    {
     ...
     */
    public static function bottomN(ResolvesToInt|int|string $n, Document|Serializable|stdClass|array $sortBy, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $output, PackedArray|ResolvesToArray|BSONArray|array|string $input): BottomNOperator
    {
     ...
     */
    public static function bsonSize(Document|Serializable|ResolvesToNull|ResolvesToObject|stdClass|array|null|string $object): BsonSizeOperator
    {
     ...
     */
    public static function case(ResolvesToBool|bool|string $case, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $then): CaseOperator
    {
     ...
     */
    public static function cmp(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): CmpOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string ...$array
     */
    public static function concatArrays(PackedArray|ResolvesToArray|BSONArray|array|string ...$array): ConcatArraysOperator
    {
     ...
     */
    public static function cond(ResolvesToBool|bool|string $if, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $then, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $else): CondOperator
    {
     ...
     */
    public static function dateAdd(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $startDate, ResolvesToString|TimeUnit|string $unit, Int64|ResolvesToInt|ResolvesToLong|int|string $amount, Optional|ResolvesToString|string $timezone = Optional::Undefined): DateAddOperator
    {
     ...
     */
    public static function dateDiff(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $startDate, DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $endDate, ResolvesToString|TimeUnit|string $unit, Optional|ResolvesToString|string $timezone = Optional::Undefined, Optional|ResolvesToString|string $startOfWeek = Optional::Undefined): DateDiffOperator
    {
     ...
     * New in MongoDB 5.0
     */
    public static function dateFromString(ResolvesToString|string $dateString, Optional|ResolvesToString|string $format = Optional::Undefined, Optional|ResolvesToString|string $timezone = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $onError = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $onNull = Optional::Undefined): DateFromStringOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone to carry out the operation. $timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function dateSubtract(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $startDate, ResolvesToString|TimeUnit|string $unit, Int64|ResolvesToInt|ResolvesToLong|int|string $amount, Optional|ResolvesToString|string $timezone = Optional::Undefined): DateSubtractOperator
    {
     ...
     */
    public static function dateToParts(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined, Optional|bool $iso8601 = Optional::Undefined): DateToPartsOperator
    {
     ...
     */
    public static function dateTrunc(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, ResolvesToString|TimeUnit|string $unit, Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $binSize = Optional::Undefined, Optional|ResolvesToString|string $timezone = Optional::Undefined, Optional|string $startOfWeek = Optional::Undefined): DateTruncOperator
    {
     ...
     */
    public static function dayOfMonth(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): DayOfMonthOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function dayOfWeek(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): DayOfWeekOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function dayOfYear(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): DayOfYearOperator
    {
     ...
     */
    public static function degreesToRadians(Decimal128|Int64|ResolvesToNumber|float|int|string $expression): DegreesToRadiansOperator
    {
     ...
     */
    public static function deserializeEJSON(Document|Serializable|ResolvesToObject|stdClass|array|string $input, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $onError = Optional::Undefined): DeserializeEJSONOperator
    {
     ...
     */
    public static function divide(Decimal128|Int64|ResolvesToNumber|float|int|string $dividend, Decimal128|Int64|ResolvesToNumber|float|int|string $divisor): DivideOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression2
     */
    public static function eq(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): EqOperator
    {
     ...
     * New in MongoDB 8.3
     */
    public static function filter(PackedArray|ResolvesToArray|BSONArray|array|string $input, ResolvesToBool|bool|string $cond, Optional|string $as = Optional::Undefined, Optional|string $arrayIndexAs = Optional::Undefined, Optional|ResolvesToInt|int|string $limit = Optional::Undefined): FilterOperator
    {
     ...
     */
    public static function firstN(ResolvesToInt|int|string $n, PackedArray|ResolvesToArray|BSONArray|array|string $input): FirstNOperator
    {
     ...
     * @param string $lang
     */
    public static function function(Javascript|string $body, PackedArray|BSONArray|array $args = [], string $lang = 'js'): FunctionOperator
    {
     ...
     */
    public static function getField(ResolvesToString|string $field, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $input = Optional::Undefined): GetFieldOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression2
     */
    public static function gt(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): GtOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression2
     */
    public static function gte(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): GteOperator
    {
     ...
     */
    public static function hash(Binary|ResolvesToBinData|ResolvesToNull|ResolvesToString|null|string $input, string $algorithm): HashOperator
    {
     ...
     * @param string $algorithm
     */
    public static function hexHash(Binary|ResolvesToBinData|ResolvesToNull|ResolvesToString|null|string $input, string $algorithm): HexHashOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function hour(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): HourOperator
    {
     ...
     */
    public static function ifNull(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): IfNullOperator
    {
     ...
     */
    public static function in(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression, PackedArray|ResolvesToArray|BSONArray|array|string $array): InOperator
    {
     ...
     */
    public static function indexOfArray(PackedArray|ResolvesToArray|BSONArray|array|string $array, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $search, Optional|ResolvesToInt|int|string $start = Optional::Undefined, Optional|ResolvesToInt|int|string $end = Optional::Undefined): IndexOfArrayOperator
    {
     ...
     * If unspecified, the ending index position for the search is the end of the string.
     */
    public static function indexOfBytes(ResolvesToString|string $string, ResolvesToString|string $substring, Optional|ResolvesToInt|int|string $start = Optional::Undefined, Optional|ResolvesToInt|int|string $end = Optional::Undefined): IndexOfBytesOperator
    {
     ...
     * If unspecified, the ending index position for the search is the end of the string.
     */
    public static function indexOfCP(ResolvesToString|string $string, ResolvesToString|string $substring, Optional|ResolvesToInt|int|string $start = Optional::Undefined, Optional|ResolvesToInt|int|string $end = Optional::Undefined): IndexOfCPOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function isArray(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): IsArrayOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function isNumber(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): IsNumberOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function isoDayOfWeek(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): IsoDayOfWeekOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function isoWeek(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): IsoWeekOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function isoWeekYear(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): IsoWeekYearOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string $input An expression that resolves to the array from which to return n elements.
     */
    public static function lastN(ResolvesToInt|int|string $n, PackedArray|ResolvesToArray|BSONArray|array|string $input): LastNOperator
    {
     ...
     */
    public static function let(Document|Serializable|stdClass|array $vars, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in): LetOperator
    {
     ...
     */
    public static function literal(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string $value): LiteralOperator
    {
     ...
     */
    public static function log(Decimal128|Int64|ResolvesToNumber|float|int|string $number, Decimal128|Int64|ResolvesToNumber|float|int|string $base): LogOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression2
     */
    public static function lt(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): LtOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression2
     */
    public static function lte(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): LteOperator
    {
     ...
     */
    public static function ltrim(ResolvesToString|string $input, Optional|ResolvesToString|string $chars = Optional::Undefined): LtrimOperator
    {
     ...
     * New in MongoDB 8.3
     */
    public static function map(PackedArray|ResolvesToArray|BSONArray|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in, Optional|string $as = Optional::Undefined, Optional|string $arrayIndexAs = Optional::Undefined): MapOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string ...$expression
     */
    public static function max(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): MaxOperator
    {
     ...
     */
    public static function maxN(PackedArray|ResolvesToArray|BSONArray|array|string $input, ResolvesToInt|int|string $n): MaxNOperator
    {
     ...
     */
    public static function median(Decimal128|Int64|PackedArray|ResolvesToNumber|BSONArray|array|float|int|string $input, string $method): MedianOperator
    {
     ...
     */
    public static function mergeObjects(Document|Serializable|ResolvesToObject|stdClass|array|string ...$document): MergeObjectsOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function millisecond(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): MillisecondOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string ...$expression
     */
    public static function min(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): MinOperator
    {
     ...
     * @param ResolvesToInt|int|string $n An expression that resolves to a positive integer. The integer specifies the number of array elements that $maxN returns.
     */
    public static function minN(PackedArray|ResolvesToArray|BSONArray|array|string $input, ResolvesToInt|int|string $n): MinNOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function minute(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): MinuteOperator
    {
     ...
     * @param Decimal128|Int64|ResolvesToNumber|float|int|string $divisor
     */
    public static function mod(Decimal128|Int64|ResolvesToNumber|float|int|string $dividend, Decimal128|Int64|ResolvesToNumber|float|int|string $divisor): ModOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function month(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): MonthOperator
    {
     ...
     */
    public static function multiply(Decimal128|Int64|ResolvesToNumber|float|int|string ...$expression): MultiplyOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression2
     */
    public static function ne(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression1, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression2): NeOperator
    {
     ...
     */
    public static function not(DateTimeInterface|Type|ResolvesToBool|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): NotOperator
    {
     ...
     */
    public static function objectToArray(Document|Serializable|ResolvesToObject|stdClass|array|string $object): ObjectToArrayOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|ResolvesToBool|Type|array|bool|float|int|null|stdClass|string ...$expression
     */
    public static function or(DateTimeInterface|Type|ResolvesToBool|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): OrOperator
    {
     ...
     */
    public static function percentile(Decimal128|Int64|PackedArray|ResolvesToNumber|BSONArray|array|float|int|string $input, PackedArray|ResolvesToArray|BSONArray|array|string $p, string $method): PercentileOperator
    {
     ...
     * @param Decimal128|Int64|ResolvesToNumber|float|int|string $exponent
     */
    public static function pow(Decimal128|Int64|ResolvesToNumber|float|int|string $number, Decimal128|Int64|ResolvesToNumber|float|int|string $exponent): PowOperator
    {
     ...
     * @param Decimal128|Int64|ResolvesToNumber|float|int|string $expression
     */
    public static function radiansToDegrees(Decimal128|Int64|ResolvesToNumber|float|int|string $expression): RadiansToDegreesOperator
    {
     ...
     */
    public static function range(ResolvesToInt|int|string $start, ResolvesToInt|int|string $end, Optional|ResolvesToInt|int|string $step = Optional::Undefined): RangeOperator
    {
     ...
     * New in MongoDB 8.3
     */
    public static function reduce(PackedArray|ResolvesToArray|BSONArray|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $initialValue, DateTimeInterface|Document|Serializable|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in, Optional|string $as = Optional::Undefined, Optional|string $valueAs = Optional::Undefined, Optional|string $arrayIndexAs = Optional::Undefined): ReduceOperator
    {
     ...
     */
    public static function regexFind(ResolvesToString|string $input, Regex|ResolvesToString|string $regex, Optional|string $options = Optional::Undefined): RegexFindOperator
    {
     ...
     * @param Optional|string $options
     */
    public static function regexFindAll(ResolvesToString|string $input, Regex|ResolvesToString|string $regex, Optional|string $options = Optional::Undefined): RegexFindAllOperator
    {
     ...
     * @param Optional|string $options
     */
    public static function regexMatch(ResolvesToString|string $input, Regex|ResolvesToString|string $regex, Optional|string $options = Optional::Undefined): RegexMatchOperator
    {
     ...
     */
    public static function replaceAll(ResolvesToNull|ResolvesToString|null|string $input, Regex|ResolvesToNull|ResolvesToRegex|ResolvesToString|null|string $find, ResolvesToNull|ResolvesToString|null|string $replacement): ReplaceAllOperator
    {
     ...
     */
    public static function replaceOne(ResolvesToNull|ResolvesToString|null|string $input, Regex|ResolvesToNull|ResolvesToRegex|ResolvesToString|null|string $find, ResolvesToNull|ResolvesToString|null|string $replacement): ReplaceOneOperator
    {
     ...
     */
    public static function reverseArray(PackedArray|ResolvesToArray|BSONArray|array|string $expression): ReverseArrayOperator
    {
     ...
     */
    public static function round(Decimal128|Int64|ResolvesToNumber|float|int|string $number, Optional|ResolvesToInt|int|string $place = Optional::Undefined): RoundOperator
    {
     ...
     * If unspecified, $ltrim removes whitespace characters, including the null character.
     */
    public static function rtrim(ResolvesToString|string $input, Optional|ResolvesToString|string $chars = Optional::Undefined): RtrimOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function second(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): SecondOperator
    {
     ...
     * If unspecified, the operation throws an error and stops.
     */
    public static function serializeEJSON(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $input, Optional|ResolvesToBool|bool|string $relaxed = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $onError = Optional::Undefined): SerializeEJSONOperator
    {
     ...
     */
    public static function setDifference(PackedArray|ResolvesToArray|BSONArray|array|string $expression1, PackedArray|ResolvesToArray|BSONArray|array|string $expression2): SetDifferenceOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string ...$expression
     */
    public static function setEquals(PackedArray|ResolvesToArray|BSONArray|array|string ...$expression): SetEqualsOperator
    {
     ...
     */
    public static function setField(ResolvesToString|string $field, Document|Serializable|ResolvesToObject|stdClass|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $value): SetFieldOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string ...$expression
     */
    public static function setIntersection(PackedArray|ResolvesToArray|BSONArray|array|string ...$expression): SetIntersectionOperator
    {
     ...
     */
    public static function setIsSubset(PackedArray|ResolvesToArray|BSONArray|array|string $expression1, PackedArray|ResolvesToArray|BSONArray|array|string $expression2): SetIsSubsetOperator
    {
     ...
     * @param BSONArray|PackedArray|ResolvesToArray|array|string ...$expression
     */
    public static function setUnion(PackedArray|ResolvesToArray|BSONArray|array|string ...$expression): SetUnionOperator
    {
     ...
     */
    public static function similarityCosine(PackedArray|ResolvesToArray|BSONArray|array|string $vectors, Optional|bool $score = Optional::Undefined): SimilarityCosineOperator
    {
     ...
     * @param Optional|bool $score If true, normalizes the result to a value between 0 and 1 for use as a vector search score. Defaults to false.
     */
    public static function similarityDotProduct(PackedArray|ResolvesToArray|BSONArray|array|string $vectors, Optional|bool $score = Optional::Undefined): SimilarityDotProductOperator
    {
     ...
     * @param Optional|bool $score If true, normalizes the result to a value between 0 and 1 for use as a vector search score. Defaults to false.
     */
    public static function similarityEuclidean(PackedArray|ResolvesToArray|BSONArray|array|string $vectors, Optional|bool $score = Optional::Undefined): SimilarityEuclideanOperator
    {
     ...
     */
    public static function slice(PackedArray|ResolvesToArray|BSONArray|array|string $expression, ResolvesToInt|int|string $n, Optional|ResolvesToInt|int|string $position = Optional::Undefined): SliceOperator
    {
     ...
     */
    public static function sortArray(PackedArray|ResolvesToArray|BSONArray|array|string $input, Document|Serializable|Sort|stdClass|array|int $sortBy): SortArrayOperator
    {
     ...
     */
    public static function split(ResolvesToString|string $string, Regex|ResolvesToRegex|ResolvesToString|string $delimiter): SplitOperator
    {
     ...
     * @param Decimal128|Int64|ResolvesToNumber|float|int|string ...$expression
     */
    public static function stdDevPop(Decimal128|Int64|ResolvesToNumber|float|int|string ...$expression): StdDevPopOperator
    {
     ...
     * @param Decimal128|Int64|ResolvesToNumber|float|int|string ...$expression
     */
    public static function stdDevSamp(Decimal128|Int64|ResolvesToNumber|float|int|string ...$expression): StdDevSampOperator
    {
     ...
     */
    public static function strcasecmp(ResolvesToString|string $expression1, ResolvesToString|string $expression2): StrcasecmpOperator
    {
     ...
     */
    public static function substr(ResolvesToString|string $string, ResolvesToInt|int|string $start, ResolvesToInt|int|string $length): SubstrOperator
    {
     ...
     * @param ResolvesToInt|int|string $length If length is a negative number, $substr returns a substring that starts at the specified index and includes the rest of the string.
     */
    public static function substrBytes(ResolvesToString|string $string, ResolvesToInt|int|string $start, ResolvesToInt|int|string $length): SubstrBytesOperator
    {
     ...
     * @param ResolvesToInt|int|string $length If length is a negative number, $substr returns a substring that starts at the specified index and includes the rest of the string.
     */
    public static function substrCP(ResolvesToString|string $string, ResolvesToInt|int|string $start, ResolvesToInt|int|string $length): SubstrCPOperator
    {
     ...
     */
    public static function subtract(DateTimeInterface|Decimal128|Int64|UTCDateTime|ResolvesToDate|ResolvesToNumber|float|int|string $expression1, DateTimeInterface|Decimal128|Int64|UTCDateTime|ResolvesToDate|ResolvesToNumber|float|int|string $expression2): SubtractOperator
    {
     ...
     */
    public static function sum(Decimal128|Int64|PackedArray|ResolvesToArray|ResolvesToNumber|BSONArray|array|float|int|string ...$expression): SumOperator
    {
     ...
     */
    public static function switch(PackedArray|BSONArray|array $branches, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $default = Optional::Undefined): SwitchOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toArray(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToArrayOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toBool(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToBoolOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toDate(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToDateOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toDecimal(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToDecimalOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toDouble(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToDoubleOperator
    {
     ...
     */
    public static function toHashedIndexKey(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $value): ToHashedIndexKeyOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toInt(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToIntOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toLong(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToLongOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toObject(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToObjectOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toObjectId(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToObjectIdOperator
    {
     ...
     */
    public static function top(Document|Serializable|stdClass|array $sortBy, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $output, PackedArray|ResolvesToArray|BSONArray|array|string $input): TopOperator
    {
     ...
     */
    public static function topN(ResolvesToInt|int|string $n, Document|Serializable|stdClass|array $sortBy, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $output, PackedArray|ResolvesToArray|BSONArray|array|string $input): TopNOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function toString(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): ToStringOperator
    {
     ...
     * If unspecified, $ltrim removes whitespace characters, including the null character.
     */
    public static function trim(ResolvesToString|string $input, Optional|ResolvesToString|string $chars = Optional::Undefined): TrimOperator
    {
     ...
     */
    public static function trunc(Decimal128|Int64|ResolvesToNumber|float|int|string $number, Optional|ResolvesToInt|int|string $place = Optional::Undefined): TruncOperator
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function type(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): TypeOperator
    {
     ...
     * @param Document|ResolvesToObject|Serializable|array|stdClass|string $input Document that contains the field that you want to add or update. input must resolve to an object, missing, null, or undefined.
     */
    public static function unsetField(ResolvesToString|string $field, Document|Serializable|ResolvesToObject|stdClass|array|string $input): UnsetFieldOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function week(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): WeekOperator
    {
     ...
     * @param Optional|ResolvesToString|string $timezone The timezone of the operation result. timezone must be a valid expression that resolves to a string formatted as either an Olson Timezone Identifier or a UTC Offset. If no timezone is provided, the result is displayed in UTC.
     */
    public static function year(DateTimeInterface|ObjectId|Timestamp|UTCDateTime|ResolvesToDate|ResolvesToObjectId|ResolvesToTimestamp|int|string $date, Optional|ResolvesToString|string $timezone = Optional::Undefined): YearOperator
    {
     ...
     */
    public static function zip(PackedArray|ResolvesToArray|BSONArray|array|string $inputs, Optional|bool $useLongestLength = Optional::Undefined, Optional|PackedArray|BSONArray|array $defaults = Optional::Undefined): ZipOperator
    {
