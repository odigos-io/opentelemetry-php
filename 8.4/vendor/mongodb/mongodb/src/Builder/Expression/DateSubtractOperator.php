 ...
 * @internal
 */
final class DateSubtractOperator implements \MongoDB\Builder\Expression\ResolvesToDate, OperatorInterface
{
    ...
    public readonly Int64|\MongoDB\Builder\Expression\ResolvesToInt|\MongoDB\Builder\Expression\ResolvesToLong|int|string $amount;
