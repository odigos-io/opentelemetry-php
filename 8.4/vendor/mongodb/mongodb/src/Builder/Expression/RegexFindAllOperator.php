 ...
 * @internal
 */
final class RegexFindAllOperator implements \MongoDB\Builder\Expression\ResolvesToArray, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToString|string $input;
    ...
    public readonly Regex|\MongoDB\Builder\Expression\ResolvesToString|string $regex;
     ...
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToString|string $input, Regex|\MongoDB\Builder\Expression\ResolvesToString|string $regex, Optional|string $options = Optional::Undefined)
    {
        $this->input = $input;
        $this->regex = $regex;
