 ...
 * @internal
 */
final class SliceOperator implements \MongoDB\Builder\Expression\ResolvesToArray, OperatorInterface
{
    ...
    public readonly PackedArray|\MongoDB\Builder\Expression\ResolvesToArray|BSONArray|array|string $expression;
    /**
     ...
     */
    public readonly Optional|\MongoDB\Builder\Expression\ResolvesToInt|int|string $position;
    /**
     ...
     * If negative, $slice determines the starting position from the end of the array. If the absolute value of the <position> is greater than the number of elements, the starting position is the start of the array.
     */
    public function __construct(PackedArray|\MongoDB\Builder\Expression\ResolvesToArray|BSONArray|array|string $expression, \MongoDB\Builder\Expression\ResolvesToInt|int|string $n, Optional|\MongoDB\Builder\Expression\ResolvesToInt|int|string $position = Optional::Undefined)
    {
