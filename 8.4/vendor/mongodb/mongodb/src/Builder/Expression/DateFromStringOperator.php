 ...
 * @internal
 */
final class DateFromStringOperator implements \MongoDB\Builder\Expression\ResolvesToDate, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToString|string $dateString;
    /**
