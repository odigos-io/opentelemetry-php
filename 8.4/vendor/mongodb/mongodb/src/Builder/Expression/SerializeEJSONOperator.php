...
final class SerializeEJSONOperator implements ResolvesToObject, OperatorInterface
{
     ...
     * If unspecified, the operation throws an error and stops.
     */
    public function __construct(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $input, Optional|ResolvesToBool|bool|string $relaxed = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $onError = Optional::Undefined)
    {
        $this->input = $input;
