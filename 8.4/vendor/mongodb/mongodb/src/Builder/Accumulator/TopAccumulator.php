...
final class TopAccumulator implements AccumulatorInterface, OperatorInterface
{
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $sortBy, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $output)
    {
        $this->sortBy = $sortBy;
        $this->output = $output;
    }
