...
final class InOperator implements SearchOperatorInterface, OperatorInterface
{
     ...
     */
    public function __construct(array|string $path, DateTimeInterface|PackedArray|Type|BSONArray|stdClass|array|bool|float|int|null|string $value, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined, Optional|PackedArray|BSONArray|array|string $doesNotAffect = Optional::Undefined)
    {
        $this->path = $path;
