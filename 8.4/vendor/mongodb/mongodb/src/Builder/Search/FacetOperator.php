...
final class FacetOperator implements SearchOperatorInterface, OperatorInterface
{
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $facets, Optional|Document|Serializable|SearchOperatorInterface|stdClass|array $operator = Optional::Undefined)
    {
        $this->facets = $facets;
