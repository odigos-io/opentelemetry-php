...
final class VectorSearchOperator implements SearchOperatorInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['path' => 'path', 'queryVector' => 'queryVector', 'limit' => 'limit', 'exact' => 'exact', 'numCandidates' => 'numCandidates', 'filter' => 'filter', 'score' => 'score'];
     ...
     */
    public function __construct(array|string $path, Binary|PackedArray|BSONArray|array|string $queryVector, int $limit, Optional|bool $exact = Optional::Undefined, Optional|int $numCandidates = Optional::Undefined, Optional|Document|Serializable|SearchOperatorInterface|stdClass|array $filter = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined)
    {
        $this->path = $path;
