...
namespace Odigos\MongoDB\Builder\Update;
...
trait FactoryTrait
{
     ...
     */
    public static function addToSet(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): AddToSetOperator
    {
     ...
     * @param DateTimeInterface|Type|array|bool|float|int|null|stdClass|string ...$field
     */
    public static function max(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): MaxOperator
    {
     ...
     * @param DateTimeInterface|Type|array|bool|float|int|null|stdClass|string ...$field
     */
    public static function min(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): MinOperator
    {
     ...
     */
    public static function pull(DateTimeInterface|Type|FieldQueryInterface|stdClass|array|bool|float|int|null|string ...$field): PullOperator
    {
     ...
     * @param DateTimeInterface|Type|array|bool|float|int|null|stdClass|string ...$field
     */
    public static function push(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): PushOperator
    {
     ...
     * @param DateTimeInterface|Type|array|bool|float|int|null|stdClass|string ...$field
     */
    public static function set(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): SetOperator
    {
     ...
     * @param DateTimeInterface|Type|array|bool|float|int|null|stdClass|string ...$field
     */
    public static function setOnInsert(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): SetOnInsertOperator
    {
     ...
     * @param DateTimeInterface|Type|array|bool|float|int|null|stdClass|string ...$field
     */
    public static function unset(DateTimeInterface|Type|stdClass|array|bool|float|int|null|string ...$field): UnsetOperator
    {
