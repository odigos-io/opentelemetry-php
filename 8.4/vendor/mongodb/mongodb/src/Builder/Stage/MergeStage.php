...
final class MergeStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['into' => 'into', 'on' => 'on', 'let' => 'let', 'whenMatched' => 'whenMatched', 'whenNotMatched' => 'whenNotMatched'];
     ...
     */
    public function __construct(Document|Serializable|stdClass|array|string $into, Optional|PackedArray|BSONArray|array|string $on = Optional::Undefined, Optional|Document|Serializable|stdClass|array $let = Optional::Undefined, Optional|PackedArray|Pipeline|BSONArray|array|string $whenMatched = Optional::Undefined, Optional|string $whenNotMatched = Optional::Undefined)
    {
        $this->into = $into;
