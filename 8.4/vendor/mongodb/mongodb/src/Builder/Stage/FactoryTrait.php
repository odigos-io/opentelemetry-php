...
trait FactoryTrait
{
     ...
     */
    public static function addFields(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): AddFieldsStage
    {
     ...
     */
    public static function bucketAuto(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $groupBy, int $buckets, Optional|Document|Serializable|stdClass|array $output = Optional::Undefined, Optional|string $granularity = Optional::Undefined): BucketAutoStage
    {
     ...
     */
    public static function collStats(Optional|Document|Serializable|stdClass|array $latencyStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $storageStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $queryExecStats = Optional::Undefined): CollStatsStage
    {
     ...
     */
    public static function currentOp(Optional|bool $allUsers = Optional::Undefined, Optional|bool $idleConnections = Optional::Undefined, Optional|bool $idleCursors = Optional::Undefined, Optional|bool $idleSessions = Optional::Undefined, Optional|bool $localOps = Optional::Undefined): CurrentOpStage
    {
     ...
     */
    public static function densify(string $field, Document|Serializable|stdClass|array $range, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined): DensifyStage
    {
     ...
     */
    public static function fill(Document|Serializable|stdClass|array $output, Optional|Document|Serializable|stdClass|array|string $partitionBy = Optional::Undefined, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sortBy = Optional::Undefined): FillStage
    {
     ...
     */
    public static function graphLookup(string $from, DateTimeInterface|PackedArray|Type|ExpressionInterface|BSONArray|stdClass|array|bool|float|int|null|string $startWith, string $connectFromField, string $connectToField, string $as, Optional|int $maxDepth = Optional::Undefined, Optional|string $depthField = Optional::Undefined, Optional|QueryInterface|array $restrictSearchWithMatch = Optional::Undefined): GraphLookupStage
    {
     ...
     */
    public static function group(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $_id, Document|Serializable|AccumulatorInterface|stdClass|array ...$field): GroupStage
    {
     ...
     */
    public static function listLocalSessions(Optional|PackedArray|BSONArray|array $users = Optional::Undefined, Optional|bool $allUsers = Optional::Undefined): ListLocalSessionsStage
    {
     ...
     */
    public static function listSampledQueries(Optional|string $namespace = Optional::Undefined): ListSampledQueriesStage
    {
     ...
     */
    public static function listSearchIndexes(Optional|string $id = Optional::Undefined, Optional|string $name = Optional::Undefined): ListSearchIndexesStage
    {
     ...
     * @param Optional|bool $allUsers Returns all sessions for all users. If running with access control, the authenticated user must have privileges with listSessions action on the cluster.
     */
    public static function listSessions(Optional|PackedArray|BSONArray|array $users = Optional::Undefined, Optional|bool $allUsers = Optional::Undefined): ListSessionsStage
    {
     ...
     */
    public static function lookup(string $as, Optional|string $from = Optional::Undefined, Optional|string $localField = Optional::Undefined, Optional|string $foreignField = Optional::Undefined, Optional|Document|Serializable|stdClass|array $let = Optional::Undefined, Optional|PackedArray|Pipeline|BSONArray|array $pipeline = Optional::Undefined): LookupStage
    {
     ...
     */
    public static function out(string $coll, Optional|string $db = Optional::Undefined, Optional|Document|Serializable|stdClass|array $timeseries = Optional::Undefined): OutStage
    {
     ...
     */
    public static function project(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$specification): ProjectStage
    {
     ...
     */
    public static function rankFusion(Document|Serializable|stdClass|array $input, Optional|Document|Serializable|stdClass|array $combination = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined): RankFusionStage
    {
     ...
     */
    public static function redact(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): RedactStage
    {
     ...
     */
    public static function replaceRoot(Document|Serializable|ResolvesToObject|stdClass|array|string $newRoot): ReplaceRootStage
    {
     ...
     */
    public static function replaceWith(Document|Serializable|ResolvesToObject|stdClass|array|string $expression): ReplaceWithStage
    {
     ...
     */
    public static function rerank(string $model, Document|Serializable|stdClass|array $query, PackedArray|BSONArray|array|string $path, int $numDocsToRerank): RerankStage
    {
     ...
     * output document.
     */
    public static function score(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $score, Optional|string $normalization = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $weight = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined): ScoreStage
    {
     ...
     * @param Optional|bool $scoreDetails Set to true to include detailed scoring information.
     */
    public static function scoreFusion(Document|Serializable|stdClass|array $input, Optional|Document|Serializable|stdClass|array $combination = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined): ScoreFusionStage
    {
     ...
     */
    public static function search(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $highlight = Optional::Undefined, Optional|bool $concurrent = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|string $searchAfter = Optional::Undefined, Optional|string $searchBefore = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sort = Optional::Undefined, Optional|Document|Serializable|stdClass|array $returnScope = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined, Optional|Document|Serializable|stdClass|array $tracking = Optional::Undefined): SearchStage
    {
     ...
     * @param Optional|bool $returnStoredSource Flag that specifies whether to perform a full document lookup on the backend database or return only stored source fields directly from Atlas Search.
     */
    public static function searchMeta(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $returnScope = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined): SearchMetaStage
    {
     ...
     */
    public static function set(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$field): SetStage
    {
     ...
     */
    public static function setWindowFields(Document|Serializable|stdClass|array $sortBy, Document|Serializable|stdClass|array $output, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $partitionBy = Optional::Undefined): SetWindowFieldsStage
    {
     ...
     */
    public static function sort(DateTimeInterface|Type|ExpressionInterface|Sort|stdClass|array|bool|float|int|null|string ...$sort): SortStage
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function sortByCount(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): SortByCountStage
    {
     ...
     */
    public static function unionWith(string $coll, Optional|PackedArray|Pipeline|BSONArray|array $pipeline = Optional::Undefined): UnionWithStage
    {
     ...
     */
    public static function unwind(ArrayFieldPath|string $path, Optional|string $includeArrayIndex = Optional::Undefined, Optional|bool $preserveNullAndEmptyArrays = Optional::Undefined): UnwindStage
    {
     ...
     * New in MongoDB 8.2
     */
    public static function vectorSearch(string $index, int $limit, string $path, Optional|Binary|PackedArray|BSONArray|array|string $queryVector = Optional::Undefined, Optional|bool $exact = Optional::Undefined, Optional|QueryInterface|array $filter = Optional::Undefined, Optional|int $numCandidates = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined, Optional|Document|Serializable|stdClass|array $nestedOptions = Optional::Undefined, Optional|QueryInterface|array $parentFilter = Optional::Undefined, Optional|string $query = Optional::Undefined, Optional|string $model = Optional::Undefined): VectorSearchStage
    {
