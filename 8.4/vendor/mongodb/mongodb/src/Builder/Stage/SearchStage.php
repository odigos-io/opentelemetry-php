...
final class SearchStage implements InputStageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['operator' => null, 'index' => 'index', 'highlight' => 'highlight', 'concurrent' => 'concurrent', 'count' => 'count', 'searchAfter' => 'searchAfter', 'searchBefore' => 'searchBefore', 'scoreDetails' => 'scoreDetails', 'sort' => 'sort', 'returnScope' => 'returnScope', 'returnStoredSource' => 'returnStoredSource', 'tracking' => 'tracking'];
    /**
     ...
     */
    public function __construct(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $highlight = Optional::Undefined, Optional|bool $concurrent = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|string $searchAfter = Optional::Undefined, Optional|string $searchBefore = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sort = Optional::Undefined, Optional|Document|Serializable|stdClass|array $returnScope = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined, Optional|Document|Serializable|stdClass|array $tracking = Optional::Undefined)
    {
