...
final class CollStatsStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['latencyStats' => 'latencyStats', 'storageStats' => 'storageStats', 'count' => 'count', 'queryExecStats' => 'queryExecStats'];
     ...
     */
    public function __construct(Optional|Document|Serializable|stdClass|array $latencyStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $storageStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $queryExecStats = Optional::Undefined)
    {
