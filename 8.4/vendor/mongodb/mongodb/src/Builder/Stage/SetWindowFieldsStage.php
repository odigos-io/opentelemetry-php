...
final class SetWindowFieldsStage implements StageInterface, OperatorInterface
{
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $sortBy, Document|Serializable|stdClass|array $output, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $partitionBy = Optional::Undefined)
    {
        $this->sortBy = $sortBy;
        $this->output = $output;
