...
use Odigos\MongoDB\Builder\Stage\OutStage;
...
final class Stage
{
     ...
     */
    public static function out(Document|Serializable|stdClass|array|string $coll, Optional|string $db = Optional::Undefined, Optional|Document|Serializable|stdClass|array $timeseries = Optional::Undefined): OutStage
    {
        if (!is_string($coll)) {
