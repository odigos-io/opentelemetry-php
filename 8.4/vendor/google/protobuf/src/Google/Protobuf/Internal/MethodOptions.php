 ...
 */
class MethodOptions extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Google\Protobuf\Internal\MethodOptions\IdempotencyLevel::class);
