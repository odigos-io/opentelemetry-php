 ...
 */
class EnumDescriptorProto extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\Internal\EnumValueDescriptorProto::class);
        $this->value = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\Internal\EnumOptions::class);
        $this->options = $var;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\Internal\EnumDescriptorProto\EnumReservedRange::class);
