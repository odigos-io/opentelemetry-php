...
use Odigos\Egulias\EmailValidator\Result\Reason\DotAtEnd;
use Odigos\Egulias\EmailValidator\Result\Reason\DotAtStart;
use Odigos\Egulias\EmailValidator\Warning\DeprecatedComment;
use Odigos\Egulias\EmailValidator\Result\Reason\CRLFAtTheEnd;
use Odigos\Egulias\EmailValidator\Result\Reason\LabelTooLong;
use Odigos\Egulias\EmailValidator\Result\Reason\NoDomainPart;
use Odigos\Egulias\EmailValidator\Result\Reason\ConsecutiveAt;
use Odigos\Egulias\EmailValidator\Result\Reason\DomainTooLong;
use Odigos\Egulias\EmailValidator\Result\Reason\CharNotAllowed;
use Odigos\Egulias\EmailValidator\Result\Reason\DomainHyphened;
use Odigos\Egulias\EmailValidator\Result\Reason\ExpectingATEXT;
use Odigos\Egulias\EmailValidator\Parser\CommentStrategy\DomainComment;
use Odigos\Egulias\EmailValidator\Result\Reason\ExpectingDomainLiteralClose;
use Odigos\Egulias\EmailValidator\Parser\DomainLiteral as DomainLiteralParser;
