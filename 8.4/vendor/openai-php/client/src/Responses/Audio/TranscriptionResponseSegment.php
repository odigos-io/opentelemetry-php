...
final class TranscriptionResponseSegment implements ResponseContract
{
    ...
    {
        return new self($attributes['id'], $attributes['start'], $attributes['end'], $attributes['text'], $attributes['seek'] ?? null, $attributes['tokens'] ?? null, $attributes['temperature'] ?? null, $attributes['avg_logprob'] ?? null, $attributes['compression_ratio'] ?? null, $attributes['no_speech_prob'] ?? null, $attributes['transient'] ?? null, $attributes['speaker'] ?? null, $attributes['type'] ?? null);
    }
    /**
     * {@inheritDoc}
     */
