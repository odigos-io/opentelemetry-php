...
class ServeCommand implements LaravelHook
{
    ...
    public function instrument(): void
    {
        ...
        hook(FoundationServeCommand::class, 'handle', pre: static function (FoundationServeCommand $_serveCommand, array $_params, string $_class, string $_function, ?string $_filename, ?int $_lineno) {
