...
{
    private function buildMessageAttributes(QueueContract $queue, string $rawPayload, ?string $queueName = null, array $options = [], mixed ...$params): array
    {
    ...
    private function contextualMessageSystemAttributes(QueueContract $queue, array $payload, ?string $queueName = null, array $options = [], mixed ...$params): array
    {
        return match (\true) {
