 ...
 */
class IntHistogramDataPoint extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Common\V1\StringKeyValue::class);
        $this->labels = $arr;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::FIXED64);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::DOUBLE);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Metrics\V1\IntExemplar::class);
        $this->exemplars = $arr;
        return $this;
    }
}
