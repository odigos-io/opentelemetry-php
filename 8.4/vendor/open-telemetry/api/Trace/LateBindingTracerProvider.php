 ...
 */
class LateBindingTracerProvider implements \OpenTelemetry\API\Trace\TracerProviderInterface
{
    private ?\OpenTelemetry\API\Trace\TracerProviderInterface $tracerProvider = null;
    ...
    {
        return $this->tracerProvider?->getTracer($name, $version, $schemaUrl, $attributes) ?? new \OpenTelemetry\API\Trace\LateBindingTracer(fn(): \OpenTelemetry\API\Trace\TracerInterface => ($this->tracerProvider ??= ($this->factory)())->getTracer($name, $version, $schemaUrl, $attributes));
    }
}
