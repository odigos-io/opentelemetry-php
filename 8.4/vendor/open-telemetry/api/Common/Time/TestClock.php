 ...
 */
final class TestClock implements \OpenTelemetry\API\Common\Time\ClockInterface
{
    ...
    {
        $this->advance($seconds * \OpenTelemetry\API\Common\Time\ClockInterface::NANOS_PER_SECOND);
    }
