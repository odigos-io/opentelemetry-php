...
class LogRecord
{
     ...
     */
    public function setSeverityNumber(\OpenTelemetry\API\Logs\Severity|int $severityNumber): self
    {
        $this->severityNumber = $severityNumber instanceof \OpenTelemetry\API\Logs\Severity ? $severityNumber->value : $severityNumber;
        return $this;
    }
    /**
