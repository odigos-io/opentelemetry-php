...
class ReadableLogRecord extends LogRecord
{
    ...
    public function __construct(private readonly InstrumentationScopeInterface $scope, private readonly \OpenTelemetry\SDK\Logs\LoggerSharedState $loggerSharedState, LogRecord $logRecord)
    {
