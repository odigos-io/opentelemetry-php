...
class SdkBuilder
{
    ...
    public function build(): \OpenTelemetry\SDK\Sdk
    {
        ...
        return new \OpenTelemetry\SDK\Sdk($tracerProvider, $meterProvider, $loggerProvider, $eventLoggerProvider, $this->propagator ?? NoopTextMapPropagator::getInstance(), $this->responsePropagator ?? NoopResponsePropagator::getInstance());
    }
    /**
