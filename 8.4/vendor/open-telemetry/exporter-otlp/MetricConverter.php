...
use Odigos\Opentelemetry\Proto\Collector\Metrics\V1\ExportMetricsServiceRequest;
use Odigos\Opentelemetry\Proto\Common\V1\InstrumentationScope;
use Odigos\Opentelemetry\Proto\Common\V1\KeyValue;
use Odigos\Opentelemetry\Proto\Metrics\V1\AggregationTemporality;
use Odigos\Opentelemetry\Proto\Metrics\V1\Exemplar;
use Odigos\Opentelemetry\Proto\Metrics\V1\Gauge;
use Odigos\Opentelemetry\Proto\Metrics\V1\Histogram;
use Odigos\Opentelemetry\Proto\Metrics\V1\HistogramDataPoint;
use Odigos\Opentelemetry\Proto\Metrics\V1\Metric;
use Odigos\Opentelemetry\Proto\Metrics\V1\NumberDataPoint;
use Odigos\Opentelemetry\Proto\Metrics\V1\ResourceMetrics;
