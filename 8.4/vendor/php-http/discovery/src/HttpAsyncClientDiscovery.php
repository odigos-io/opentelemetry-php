...
final class HttpAsyncClientDiscovery extends \Http\Discovery\ClassDiscovery
{
    ...
    public static function find()
    {
        try {
            ...
            throw new \Http\Discovery\NotFoundException('No HTTPlug async clients found. Make sure to install a package providing "php-http/async-client-implementation". Example: "php-http/guzzle6-adapter".', 0, $e);
        }
