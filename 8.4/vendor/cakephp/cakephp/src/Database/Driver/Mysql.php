...
class Mysql extends Driver
{
     ...
     */
    protected array $_baseConfig = ['persistent' => \true, 'host' => 'localhost', 'username' => 'root', 'password' => '', 'database' => 'cake', 'port' => '3306', 'flags' => [], 'encoding' => 'utf8mb4', 'timezone' => null, 'init' => []];
    /**
     ...
     */
    protected array $featureVersions = ['mysql' => ['json' => '5.7.0', 'cte' => '8.0.0', 'window' => '8.0.0', 'intersect' => '8.0.31', 'intersect-all' => '8.0.31', 'check-constraints' => '8.0.16'], 'mariadb' => ['json' => '10.2.7', 'cte' => '10.2.1', 'window' => '10.2.0', 'intersect' => '10.3.0', 'intersect-all' => '10.5.0', 'check-constraints' => '10.2.1']];
    /**
     * @inheritDoc
     */
    public function connect(): void
    {
        ...
        $config['flags'] += [PDO::ATTR_PERSISTENT => $config['persistent'], $this->attrUseBufferedQueryId() => \true, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION];
    ...
    public function run(Query $query): StatementInterface
    {
        ...
        if ($query instanceof SelectQuery) {
            try {
                ...
                $this->getPdo()->setAttribute($this->attrUseBufferedQueryId(), \true);
            }
        } else {
            $this->executeStatement($statement);
        }
    ...
    public function supports(DriverFeatureEnum $feature): bool
    {
        $versionCompare = function () use ($feature) {
            return version_compare($this->version(), $this->featureVersions[$this->serverType][$feature->value], '>=');
        };
        return match ($feature) {
            DriverFeatureEnum::DISABLE_CONSTRAINT_WITHOUT_TRANSACTION, DriverFeatureEnum::SAVEPOINT => \true,
            DriverFeatureEnum::TRUNCATE_WITH_CONSTRAINTS => \false,
            DriverFeatureEnum::CTE, DriverFeatureEnum::JSON, DriverFeatureEnum::WINDOW => $versionCompare(),
            ...
            DriverFeatureEnum::OPTIMIZER_HINT_COMMENT => \true,
        };
    }
    /**
