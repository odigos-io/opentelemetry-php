...
class RateLimitMiddleware implements MiddlewareInterface
{
     ...
     */
    protected array $defaultConfig = ['limit' => 60, 'window' => 60, 'identifier' => self::IDENTIFIER_IP, 'strategy' => self::STRATEGY_SLIDING_WINDOW, 'strategyClass' => null, 'cache' => 'default', 'headers' => \true, 'message' => 'Rate limit exceeded. Please try again later.', 'skipCheck' => null, 'costCallback' => null, 'identifierCallback' => null, 'limitCallback' => null, 'ipHeader' => 'x-forwarded-for', 'includeRetryAfter' => \true, 'keyGenerator' => null, 'tokenHeaders' => ['Authorization', 'X-API-Key'], 'limiters' => [], 'limiterResolver' => null];
    /**
     * Configuration
     *
     * @var array<string, mixed>
    ...
    {
        return $response->withHeader('X-RateLimit-Limit', (string) $result['limit'])->withHeader('X-RateLimit-Remaining', (string) $result['remaining'])->withHeader('X-RateLimit-Reset', (string) $result['reset'])->withHeader('X-RateLimit-Reset-Date', date('c', $result['reset']));
    }
}
