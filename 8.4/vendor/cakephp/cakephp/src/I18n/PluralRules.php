...
class PluralRules
{
    ...
    public static function calculate(string $locale, int $n): int
    {
        ...
        return match (static::$_rulesMap[$locale]) {
            ...
            1 => $n === 1 ? 0 : 1,
            2 => $n > 1 ? 1 : 0,
            3 => $n % 10 === 1 && $n % 100 !== 11 ? 0 : ($n % 10 >= 2 && $n % 10 <= 4 && ($n % 100 < 10 || $n % 100 >= 20) ? 1 : 2),
            4 => $n === 1 ? 0 : ($n >= 2 && $n <= 4 ? 1 : 2),
            5 => $n === 1 ? 0 : ($n === 2 ? 1 : ($n < 7 ? 2 : ($n < 11 ? 3 : 4))),
            6 => $n % 10 === 1 && $n % 100 !== 11 ? 0 : ($n % 10 >= 2 && ($n % 100 < 10 || $n % 100 >= 20) ? 1 : 2),
            7 => $n % 100 === 1 ? 1 : ($n % 100 === 2 ? 2 : ($n % 100 === 3 || $n % 100 === 4 ? 3 : 0)),
