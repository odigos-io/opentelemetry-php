...
use Odigos\Carbon\Exceptions\InvalidTypeException;
use Odigos\Carbon\Exceptions\NotLocaleAwareException;
use Odigos\Carbon\Language;
...
if (interface_exists('Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('Symfony\Component\Translation\TranslatorInterface')) {
