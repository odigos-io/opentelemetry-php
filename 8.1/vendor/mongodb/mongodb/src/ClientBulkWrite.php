...
final class ClientBulkWrite
{
    ...
    public static function createWithCollection(\MongoDB\Collection $collection, array $options = []): self
    {
        ...
        return new self(new BulkWriteCommand($options), $collection->getManager(), $collection->getNamespace(), $collection->getBuilderEncoder(), $collection->getCodec());
    }
    ...
    public function withCollection(\MongoDB\Collection $collection): self
    {
        ...
        return new self($this->bulkWriteCommand, $this->manager, $collection->getNamespace(), $collection->getBuilderEncoder(), $collection->getCodec());
    }
}
