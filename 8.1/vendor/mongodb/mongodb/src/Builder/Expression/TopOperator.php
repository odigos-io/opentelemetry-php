...
final class TopOperator implements ResolvesToAny, OperatorInterface
{
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $sortBy, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $output, PackedArray|ResolvesToArray|BSONArray|array|string $input)
    {
        $this->sortBy = $sortBy;
        $this->output = $output;
