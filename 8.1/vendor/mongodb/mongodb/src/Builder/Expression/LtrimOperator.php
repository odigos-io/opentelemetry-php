 ...
 * @internal
 */
final class LtrimOperator implements \MongoDB\Builder\Expression\ResolvesToString, OperatorInterface
{
     ...
     */
    public readonly Optional|\MongoDB\Builder\Expression\ResolvesToString|string $chars;
    /**
     ...
     * If unspecified, $ltrim removes whitespace characters, including the null character.
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToString|string $input, Optional|\MongoDB\Builder\Expression\ResolvesToString|string $chars = Optional::Undefined)
    {
        $this->input = $input;
        $this->chars = $chars;
    }
