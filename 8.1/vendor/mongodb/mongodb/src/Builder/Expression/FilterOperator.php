...
final class FilterOperator implements ResolvesToArray, OperatorInterface
{
    ...
    public const PROPERTIES = ['input' => 'input', 'cond' => 'cond', 'as' => 'as', 'arrayIndexAs' => 'arrayIndexAs', 'limit' => 'limit'];
     ...
     * New in MongoDB 8.3
     */
    public function __construct(PackedArray|ResolvesToArray|BSONArray|array|string $input, ResolvesToBool|bool|string $cond, Optional|string $as = Optional::Undefined, Optional|string $arrayIndexAs = Optional::Undefined, Optional|ResolvesToInt|int|string $limit = Optional::Undefined)
    {
