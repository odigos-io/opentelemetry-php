 ...
 * @internal
 */
final class AddOperator implements \MongoDB\Builder\Expression\ResolvesToInt, \MongoDB\Builder\Expression\ResolvesToLong, \MongoDB\Builder\Expression\ResolvesToDouble, \MongoDB\Builder\Expression\ResolvesToDecimal, \MongoDB\Builder\Expression\ResolvesToDate, OperatorInterface
{
     ...
     * @no-named-arguments
     */
    public function __construct(DateTimeInterface|Decimal128|Int64|UTCDateTime|\MongoDB\Builder\Expression\ResolvesToDate|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string ...$expression)
    {
