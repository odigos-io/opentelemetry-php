 ...
 * @internal
 */
final class UnsetFieldOperator implements \MongoDB\Builder\Expression\ResolvesToObject, OperatorInterface
{
     ...
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToString|string $field, Document|Serializable|\MongoDB\Builder\Expression\ResolvesToObject|stdClass|array|string $input)
    {
        $this->field = $field;
