 ...
 * @internal
 */
final class SwitchOperator implements \MongoDB\Builder\Expression\ResolvesToAny, OperatorInterface
{
     ...
     * Although optional, if default is unspecified and no branch case evaluates to true, $switch returns an error.
     */
    public function __construct(PackedArray|BSONArray|array $branches, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $default = Optional::Undefined)
    {
