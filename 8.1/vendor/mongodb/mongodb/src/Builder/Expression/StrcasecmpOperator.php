 ...
 * @internal
 */
final class StrcasecmpOperator implements \MongoDB\Builder\Expression\ResolvesToInt, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToString|string $expression1;
    /** @var ResolvesToString|string $expression2 */
    public readonly \MongoDB\Builder\Expression\ResolvesToString|string $expression2;
    /**
     * @param ResolvesToString|string $expression1
     * @param ResolvesToString|string $expression2
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToString|string $expression1, \MongoDB\Builder\Expression\ResolvesToString|string $expression2)
    {
