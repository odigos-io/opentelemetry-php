 ...
 * @internal
 */
final class ReplaceOneOperator implements \MongoDB\Builder\Expression\ResolvesToString, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToNull|\MongoDB\Builder\Expression\ResolvesToString|null|string $input;
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToNull|\MongoDB\Builder\Expression\ResolvesToString|null|string $find;
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToNull|\MongoDB\Builder\Expression\ResolvesToString|null|string $replacement;
    /**
