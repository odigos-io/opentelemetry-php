 ...
 * @internal
 */
final class ArrayElemAtOperator implements \MongoDB\Builder\Expression\ResolvesToAny, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToInt|int|string $idx;
    /**
     * @param BSONArray|PackedArray|ResolvesToArray|array|string $array
     * @param ResolvesToInt|int|string $idx
     */
    public function __construct(PackedArray|\MongoDB\Builder\Expression\ResolvesToArray|BSONArray|array|string $array, \MongoDB\Builder\Expression\ResolvesToInt|int|string $idx)
    {
