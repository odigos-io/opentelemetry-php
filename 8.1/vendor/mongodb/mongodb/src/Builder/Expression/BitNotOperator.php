 ...
 * @internal
 */
final class BitNotOperator implements \MongoDB\Builder\Expression\ResolvesToInt, \MongoDB\Builder\Expression\ResolvesToLong, OperatorInterface
{
    public const ENCODE = Encode::Single;
    public const NAME = '$bitNot';
    public const PROPERTIES = ['expression' => 'expression'];
    /** @var Int64|ResolvesToInt|ResolvesToLong|int|string $expression */
    public readonly Int64|\MongoDB\Builder\Expression\ResolvesToInt|\MongoDB\Builder\Expression\ResolvesToLong|int|string $expression;
    /**
     * @param Int64|ResolvesToInt|ResolvesToLong|int|string $expression
     */
    public function __construct(Int64|\MongoDB\Builder\Expression\ResolvesToInt|\MongoDB\Builder\Expression\ResolvesToLong|int|string $expression)
    {
