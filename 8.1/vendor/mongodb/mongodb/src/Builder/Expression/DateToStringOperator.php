 ...
 * @internal
 */
final class DateToStringOperator implements \MongoDB\Builder\Expression\ResolvesToString, OperatorInterface
{
     ...
     */
    public readonly Optional|\MongoDB\Builder\Expression\ResolvesToString|string $format;
