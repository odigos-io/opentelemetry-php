...
final class CurrentOpStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['allUsers' => 'allUsers', 'idleConnections' => 'idleConnections', 'idleCursors' => 'idleCursors', 'idleSessions' => 'idleSessions', 'localOps' => 'localOps'];
     ...
     */
    public function __construct(Optional|bool $allUsers = Optional::Undefined, Optional|bool $idleConnections = Optional::Undefined, Optional|bool $idleCursors = Optional::Undefined, Optional|bool $idleSessions = Optional::Undefined, Optional|bool $localOps = Optional::Undefined)
    {
