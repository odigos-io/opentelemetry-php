...
final class GroupStage implements StageInterface, OperatorInterface
{
     ...
     */
    public function __construct(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $_id, Document|Serializable|AccumulatorInterface|stdClass|array ...$field)
    {
        $this->_id = $_id;
