...
final class RerankStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['model' => 'model', 'query' => 'query', 'path' => 'path', 'numDocsToRerank' => 'numDocsToRerank'];
     ...
     */
    public function __construct(string $model, Document|Serializable|stdClass|array $query, PackedArray|BSONArray|array|string $path, int $numDocsToRerank)
    {
        $this->model = $model;
        $this->query = $query;
