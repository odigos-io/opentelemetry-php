...
final class GraphLookupStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['from' => 'from', 'startWith' => 'startWith', 'connectFromField' => 'connectFromField', 'connectToField' => 'connectToField', 'as' => 'as', 'maxDepth' => 'maxDepth', 'depthField' => 'depthField', 'restrictSearchWithMatch' => 'restrictSearchWithMatch'];
    /**
     ...
     */
    public function __construct(string $from, DateTimeInterface|PackedArray|Type|ExpressionInterface|BSONArray|stdClass|array|bool|float|int|null|string $startWith, string $connectFromField, string $connectToField, string $as, Optional|int $maxDepth = Optional::Undefined, Optional|string $depthField = Optional::Undefined, Optional|QueryInterface|array $restrictSearchWithMatch = Optional::Undefined)
    {
        $this->from = $from;
