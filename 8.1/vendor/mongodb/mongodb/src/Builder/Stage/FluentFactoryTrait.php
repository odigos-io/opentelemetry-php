...
trait FluentFactoryTrait
{
     ...
     */
    public function match(DateTimeInterface|QueryInterface|FieldQueryInterface|Type|stdClass|array|string|int|float|bool|null ...$queries): static
    {
     ...
     */
    public function out(Document|Serializable|stdClass|array|string $coll, Optional|string $db = Optional::Undefined, Optional|Document|Serializable|stdClass|array $timeseries = Optional::Undefined): static
    {
     ...
     */
    public function addFields(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null ...$expression): static
    {
     ...
     */
    public function bucket(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $groupBy, PackedArray|BSONArray|array $boundaries, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $default = Optional::Undefined, Optional|Document|Serializable|stdClass|array $output = Optional::Undefined): static
    {
     ...
     */
    public function bucketAuto(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $groupBy, int $buckets, Optional|Document|Serializable|stdClass|array $output = Optional::Undefined, Optional|string $granularity = Optional::Undefined): static
    {
     ...
     */
    public function changeStream(Optional|bool $allChangesForCluster = Optional::Undefined, Optional|string $fullDocument = Optional::Undefined, Optional|string $fullDocumentBeforeChange = Optional::Undefined, Optional|int $resumeAfter = Optional::Undefined, Optional|bool $showExpandedEvents = Optional::Undefined, Optional|Document|Serializable|stdClass|array $startAfter = Optional::Undefined, Optional|Timestamp|int $startAtOperationTime = Optional::Undefined): static
    {
     ...
     */
    public function collStats(Optional|Document|Serializable|stdClass|array $latencyStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $storageStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $queryExecStats = Optional::Undefined): static
    {
     ...
     */
    public function currentOp(Optional|bool $allUsers = Optional::Undefined, Optional|bool $idleConnections = Optional::Undefined, Optional|bool $idleCursors = Optional::Undefined, Optional|bool $idleSessions = Optional::Undefined, Optional|bool $localOps = Optional::Undefined): static
    {
     ...
     */
    public function densify(string $field, Document|Serializable|stdClass|array $range, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined): static
    {
     ...
     */
    public function fill(Document|Serializable|stdClass|array $output, Optional|Document|Serializable|stdClass|array|string $partitionBy = Optional::Undefined, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sortBy = Optional::Undefined): static
    {
     ...
     */
    public function graphLookup(string $from, DateTimeInterface|PackedArray|Type|ExpressionInterface|BSONArray|stdClass|array|string|int|float|bool|null $startWith, string $connectFromField, string $connectToField, string $as, Optional|int $maxDepth = Optional::Undefined, Optional|string $depthField = Optional::Undefined, Optional|QueryInterface|array $restrictSearchWithMatch = Optional::Undefined): static
    {
     ...
     */
    public function group(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $_id, Document|Serializable|AccumulatorInterface|stdClass|array ...$field): static
    {
     ...
     */
    public function listLocalSessions(Optional|PackedArray|BSONArray|array $users = Optional::Undefined, Optional|bool $allUsers = Optional::Undefined): static
    {
     ...
     */
    public function listSearchIndexes(Optional|string $id = Optional::Undefined, Optional|string $name = Optional::Undefined): static
    {
     ...
     * @param Optional|bool $allUsers Returns all sessions for all users. If running with access control, the authenticated user must have privileges with listSessions action on the cluster.
     */
    public function listSessions(Optional|PackedArray|BSONArray|array $users = Optional::Undefined, Optional|bool $allUsers = Optional::Undefined): static
    {
     ...
     */
    public function lookup(string $as, Optional|string $from = Optional::Undefined, Optional|string $localField = Optional::Undefined, Optional|string $foreignField = Optional::Undefined, Optional|Document|Serializable|stdClass|array $let = Optional::Undefined, Optional|PackedArray|Pipeline|BSONArray|array $pipeline = Optional::Undefined): static
    {
     ...
     */
    public function merge(Document|Serializable|stdClass|array|string $into, Optional|PackedArray|BSONArray|array|string $on = Optional::Undefined, Optional|Document|Serializable|stdClass|array $let = Optional::Undefined, Optional|PackedArray|Pipeline|BSONArray|array|string $whenMatched = Optional::Undefined, Optional|string $whenNotMatched = Optional::Undefined): static
    {
     ...
     */
    public function project(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null ...$specification): static
    {
     ...
     */
    public function rankFusion(Document|Serializable|stdClass|array $input, Optional|Document|Serializable|stdClass|array $combination = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined): static
    {
     ...
     */
    public function redact(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $expression): static
    {
     ...
     */
    public function rerank(string $model, Document|Serializable|stdClass|array $query, PackedArray|BSONArray|array|string $path, int $numDocsToRerank): static
    {
     ...
     * output document.
     */
    public function score(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $score, Optional|string $normalization = Optional::Undefined, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $weight = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined): static
    {
     ...
     * @param Optional|bool $scoreDetails Set to true to include detailed scoring information.
     */
    public function scoreFusion(Document|Serializable|stdClass|array $input, Optional|Document|Serializable|stdClass|array $combination = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined): static
    {
     ...
     */
    public function search(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $highlight = Optional::Undefined, Optional|bool $concurrent = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|string $searchAfter = Optional::Undefined, Optional|string $searchBefore = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sort = Optional::Undefined, Optional|Document|Serializable|stdClass|array $returnScope = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined, Optional|Document|Serializable|stdClass|array $tracking = Optional::Undefined): static
    {
     ...
     * @param Optional|bool $returnStoredSource Flag that specifies whether to perform a full document lookup on the backend database or return only stored source fields directly from Atlas Search.
     */
    public function searchMeta(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $returnScope = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined): static
    {
     ...
     */
    public function set(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null ...$field): static
    {
     ...
     */
    public function setWindowFields(Document|Serializable|stdClass|array $sortBy, Document|Serializable|stdClass|array $output, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $partitionBy = Optional::Undefined): static
    {
     ...
     */
    public function sort(DateTimeInterface|Type|ExpressionInterface|Sort|stdClass|array|string|int|float|bool|null ...$sort): static
    {
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public function sortByCount(DateTimeInterface|Type|ExpressionInterface|stdClass|array|string|int|float|bool|null $expression): static
    {
     ...
     */
    public function unionWith(string $coll, Optional|PackedArray|Pipeline|BSONArray|array $pipeline = Optional::Undefined): static
    {
     ...
     */
    public function unwind(ArrayFieldPath|string $path, Optional|string $includeArrayIndex = Optional::Undefined, Optional|bool $preserveNullAndEmptyArrays = Optional::Undefined): static
    {
