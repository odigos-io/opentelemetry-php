...
final class ScoreFusionStage implements StageInterface, OperatorInterface
{
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $input, Optional|Document|Serializable|stdClass|array $combination = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined)
    {
        $this->input = $input;
