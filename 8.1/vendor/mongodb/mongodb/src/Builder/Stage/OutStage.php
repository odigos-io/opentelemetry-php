...
final class OutStage implements OutputStageInterface, OperatorInterface
{
     ...
     * New in MongoDB 7.0.3
     */
    public function __construct(string $coll, Optional|string $db = Optional::Undefined, Optional|Document|Serializable|stdClass|array $timeseries = Optional::Undefined)
    {
        $this->coll = $coll;
        $this->db = $db;
