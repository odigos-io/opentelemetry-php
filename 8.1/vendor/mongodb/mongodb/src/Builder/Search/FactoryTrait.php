...
trait FactoryTrait
{
     ...
     */
    public static function autocomplete(array|string $path, string $query, Optional|string $tokenOrder = Optional::Undefined, Optional|Document|Serializable|stdClass|array $fuzzy = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): AutocompleteOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function embeddedDocument(array|string $path, Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): EmbeddedDocumentOperator
    {
     ...
     * @param Optional|BSONArray|PackedArray|array|string $doesNotAffect
     */
    public static function equals(array|string $path, DateTimeInterface|Binary|Decimal128|Int64|ObjectId|UTCDateTime|bool|float|int|null|string $value, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined, Optional|PackedArray|BSONArray|array|string $doesNotAffect = Optional::Undefined): EqualsOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function exists(array|string $path, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): ExistsOperator
    {
     ...
     */
    public static function facet(Document|Serializable|stdClass|array $facets, Optional|Document|Serializable|SearchOperatorInterface|stdClass|array $operator = Optional::Undefined): FacetOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function geoShape(array|string $path, string $relation, Document|Serializable|GeometryInterface|stdClass|array $geometry, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): GeoShapeOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function geoWithin(array|string $path, Optional|Document|Serializable|stdClass|array $box = Optional::Undefined, Optional|Document|Serializable|stdClass|array $circle = Optional::Undefined, Optional|Document|Serializable|GeometryInterface|stdClass|array $geometry = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): GeoWithinOperator
    {
     ...
     * @param Document|SearchOperatorInterface|Serializable|array|stdClass $operator
     */
    public static function hasAncestor(array|string $ancestorPath, Document|Serializable|SearchOperatorInterface|stdClass|array $operator): HasAncestorOperator
    {
     ...
     * @param Document|SearchOperatorInterface|Serializable|array|stdClass $operator
     */
    public static function hasRoot(Document|Serializable|SearchOperatorInterface|stdClass|array $operator): HasRootOperator
    {
     ...
     * @param Optional|BSONArray|PackedArray|array|string $doesNotAffect
     */
    public static function in(array|string $path, DateTimeInterface|PackedArray|Type|BSONArray|stdClass|array|bool|float|int|null|string $value, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined, Optional|PackedArray|BSONArray|array|string $doesNotAffect = Optional::Undefined): InOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function moreLikeThis(Document|PackedArray|Serializable|BSONArray|stdClass|array $like, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): MoreLikeThisOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function near(array|string $path, DateTimeInterface|Decimal128|Document|Int64|Serializable|UTCDateTime|GeometryInterface|stdClass|array|float|int $origin, Decimal128|Int64|float|int $pivot, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): NearOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function phrase(array|string $path, PackedArray|BSONArray|array|string $query, Optional|int $slop = Optional::Undefined, Optional|string $synonyms = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): PhraseOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function regex(array|string $path, string $query, Optional|bool $allowAnalyzedField = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): RegexOperator
    {
     ...
     */
    public static function vectorSearch(array|string $path, Binary|PackedArray|BSONArray|array|string $queryVector, int $limit, Optional|bool $exact = Optional::Undefined, Optional|int $numCandidates = Optional::Undefined, Optional|Document|Serializable|SearchOperatorInterface|stdClass|array $filter = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): VectorSearchOperator
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass $score
     */
    public static function wildcard(array|string $path, string $query, Optional|bool $allowAnalyzedField = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined): WildcardOperator
    {
