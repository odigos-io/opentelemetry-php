...
final class RangeOperator implements SearchOperatorInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['path' => 'path', 'gt' => 'gt', 'gte' => 'gte', 'lt' => 'lt', 'lte' => 'lte', 'score' => 'score'];
