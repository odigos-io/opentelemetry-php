...
use Odigos\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Odigos\Monolog\Level;
use Odigos\Monolog\Formatter\FormatterInterface;
use Odigos\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Odigos\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Odigos\Elasticsearch\Client;
use Odigos\Monolog\LogRecord;
use Odigos\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Odigos\Elastic\Elasticsearch\Client as Client8;
/**
