...
use Odigos\PhpConsole\Connector;
use Odigos\PhpConsole\Handler as VendorPhpConsoleHandler;
use Odigos\PhpConsole\Helper;
use Odigos\Monolog\LogRecord;
use Odigos\PhpConsole\Storage;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('Odigos\PhpConsole\Connector')) {
