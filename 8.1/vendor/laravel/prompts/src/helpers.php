...
if (!function_exists('\Laravel\Prompts\text')) {
    ...
    {
        return (new \Laravel\Prompts\TextPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\textarea')) {
    ...
    {
        return (new \Laravel\Prompts\TextareaPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\password')) {
    ...
    {
        return (new \Laravel\Prompts\PasswordPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\select')) {
    ...
    {
        return (new \Laravel\Prompts\SelectPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\multiselect')) {
    ...
    {
        return (new \Laravel\Prompts\MultiSelectPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\confirm')) {
    ...
    {
        return (new \Laravel\Prompts\ConfirmPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\pause')) {
    ...
    {
        return (new \Laravel\Prompts\PausePrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\suggest')) {
    ...
    {
        return (new \Laravel\Prompts\SuggestPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\search')) {
    ...
    {
        return (new \Laravel\Prompts\SearchPrompt(...func_get_args()))->prompt();
    }
}
if (!function_exists('\Laravel\Prompts\multisearch')) {
    ...
    {
        return (new \Laravel\Prompts\MultiSearchPrompt(...func_get_args()))->prompt();
    }
}
