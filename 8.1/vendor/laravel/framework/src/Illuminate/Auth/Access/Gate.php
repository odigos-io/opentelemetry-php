...
class Gate implements GateContract
{
    ...
    protected function authorizeOnDemand($condition, $message, $code, $allowWhenResponseIs)
    {
        ...
        return with($response instanceof \Illuminate\Auth\Access\Response ? $response : new \Illuminate\Auth\Access\Response((bool) $response === $allowWhenResponseIs, $message, $code))->authorize();
    }
    /**
