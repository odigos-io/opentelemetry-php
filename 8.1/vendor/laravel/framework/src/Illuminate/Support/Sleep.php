...
class Sleep
{
    ...
    public static function until($timestamp)
    {
        if (is_numeric($timestamp)) {
            $timestamp = \Illuminate\Support\Carbon::createFromTimestamp($timestamp);
        }
    ...
    public static function assertSequence($sequence)
    {
        ...
        collect($sequence)->zip(static::$sequence)->eachSpread(function (?\Illuminate\Support\Sleep $expected, CarbonInterval $actual) {
            if ($expected === null) {
                return;
            }
