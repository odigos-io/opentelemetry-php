    ...
    protected function runQueryCallback($query, $bindings, Closure $callback)
    {
        ...
        try {
            ...
            if ($this->isUniqueConstraintError($e)) {
                throw new \Illuminate\Database\UniqueConstraintViolationException($this->getName(), $query, $this->prepareBindings($bindings), $e);
            }
            throw new \Illuminate\Database\QueryException($this->getName(), $query, $this->prepareBindings($bindings), $e);
        }
    }
    /**
