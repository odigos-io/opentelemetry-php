...
class HasManyThrough extends \Illuminate\Database\Eloquent\Relations\Relation
{
    ...
    public function one()
    {
        return \Illuminate\Database\Eloquent\Relations\HasOneThrough::noConstraints(fn() => new \Illuminate\Database\Eloquent\Relations\HasOneThrough($this->getQuery(), $this->farParent, $this->throughParent, $this->getFirstKeyName(), $this->secondKey, $this->getLocalKeyName(), $this->getSecondLocalKeyName()));
    }
    /**
