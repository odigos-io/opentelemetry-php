...
class CompiledRouteCollection extends \Illuminate\Routing\AbstractRouteCollection
{
    ...
    {
        return collect($this->getRoutes())->groupBy(function (\Illuminate\Routing\Route $route) {
    ...
    {
        return collect($this->getRoutes())->keyBy(function (\Illuminate\Routing\Route $route) {
