    ...
    protected function queueNotification($notifiables, $notification)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            foreach ((array) $original->via($notifiable) as $channel) {
                ...
                $this->bus->dispatch((new \Illuminate\Notifications\SendQueuedNotifications($notifiable, $notification, [$channel]))->onConnection($connection)->onQueue($queue)->delay(is_array($delay) ? $delay[$channel] ?? null : $delay)->through($middleware));
            }
        }
    }
    /**
