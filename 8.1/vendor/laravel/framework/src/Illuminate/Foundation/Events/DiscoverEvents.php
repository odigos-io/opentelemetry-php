...
class DiscoverEvents
{
    ...
    {
        $listeners = collect(static::getListenerEvents(Finder::create()->files()->in($listenerPath), $basePath));
        $discoveredEvents = [];
    ...
    protected static function classFromFile(SplFileInfo $file, $basePath)
    {
        ...
        return str_replace([\DIRECTORY_SEPARATOR, ucfirst(basename(app()->path())) . '\\'], ['\\', app()->getNamespace()], ucfirst(Str::replaceLast('.php', '', $class)));
    }
    /**
