...
class Line extends \Illuminate\Console\View\Components\Component
{
     ...
     */
    protected static $styles = ['info' => ['bgColor' => 'blue', 'fgColor' => 'white', 'title' => 'info'], 'warn' => ['bgColor' => 'yellow', 'fgColor' => 'black', 'title' => 'warn'], 'error' => ['bgColor' => 'red', 'fgColor' => 'white', 'title' => 'error']];
    /**
