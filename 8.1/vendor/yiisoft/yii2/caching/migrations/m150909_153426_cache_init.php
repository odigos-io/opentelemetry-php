...
class m150909_153426_cache_init extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable($cache->cacheTable, ['id' => $this->string(128)->notNull(), 'expire' => $this->integer(), 'data' => $this->binary(), 'PRIMARY KEY ([[id]])'], $tableOptions);
    }
    /**
     * {@inheritdoc}
     */
 ...
 * @since 2.0.7
 */
\class_alias('Odigos\m150909_153426_cache_init', 'm150909_153426_cache_init', \false);
