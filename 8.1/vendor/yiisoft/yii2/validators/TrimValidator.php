...
class TrimValidator extends \yii\validators\Validator
{
    ...
    public function validateAttribute($model, $attribute)
    {
        ...
        if (!$this->skipOnArray || !is_array($value)) {
            $model->{$attribute} = is_array($value) ? array_map([$this, 'trimValue'], $value) : $this->trimValue($value);
        }
    }
    /**
    ...
    {
        return ['skipOnArray' => (bool) $this->skipOnArray, 'skipOnEmpty' => (bool) $this->skipOnEmpty, 'chars' => $this->chars ?: \false];
    }
}
