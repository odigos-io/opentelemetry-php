...
class BaseJson
{
    ...
    {
        $expressions = [];
        $value = static::processData($value, $expressions, uniqid('', \true));
        set_error_handler(function () {
            static::handleJsonError(\JSON_ERROR_SYNTAX);
        }, \E_WARNING);
        if (static::$prettyPrint === \true) {
     ...
     */
    public static function decode($json, $asArray = \true)
    {
        if (is_array($json)) {
