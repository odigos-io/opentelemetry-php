 ...
 */
class ServiceDescriptorProto extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\Internal\MethodDescriptorProto::class);
        $this->method = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\Internal\ServiceOptions::class);
        $this->options = $var;
        return $this;
    }
}
