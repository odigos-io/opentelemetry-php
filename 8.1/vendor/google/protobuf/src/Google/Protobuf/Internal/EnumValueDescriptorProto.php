 ...
 */
class EnumValueDescriptorProto extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\Internal\EnumValueOptions::class);
        $this->options = $var;
        return $this;
    }
}
