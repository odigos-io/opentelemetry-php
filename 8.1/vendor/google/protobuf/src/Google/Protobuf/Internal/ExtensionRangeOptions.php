 ...
 */
class ExtensionRangeOptions extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\Internal\ExtensionRangeOptions\Declaration::class);
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Google\Protobuf\Internal\ExtensionRangeOptions\VerificationState::class);
