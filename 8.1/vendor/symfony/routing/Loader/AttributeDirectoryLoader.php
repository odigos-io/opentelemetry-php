...
if (!class_exists(\Symfony\Component\Routing\Loader\AnnotationDirectoryLoader::class, \false)) {
    class_alias(\Symfony\Component\Routing\Loader\AttributeDirectoryLoader::class, \Symfony\Component\Routing\Loader\AnnotationDirectoryLoader::class);
}
