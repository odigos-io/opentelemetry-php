...
{
    protected $loader;
    public function __construct(FileLocatorInterface $locator, \Symfony\Component\Routing\Loader\AttributeClassLoader $loader)
    {
...
if (!class_exists(\Symfony\Component\Routing\Loader\AnnotationFileLoader::class, \false)) {
    class_alias(\Symfony\Component\Routing\Loader\AttributeFileLoader::class, \Symfony\Component\Routing\Loader\AnnotationFileLoader::class);
}
