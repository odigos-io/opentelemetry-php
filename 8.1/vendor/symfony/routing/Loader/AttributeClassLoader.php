...
if (!class_exists(\Symfony\Component\Routing\Loader\AnnotationClassLoader::class, \false)) {
    class_alias(\Symfony\Component\Routing\Loader\AttributeClassLoader::class, \Symfony\Component\Routing\Loader\AnnotationClassLoader::class);
}
