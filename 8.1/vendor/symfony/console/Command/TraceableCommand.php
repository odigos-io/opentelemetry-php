 ...
 */
final class TraceableCommand extends \Symfony\Component\Console\Command\Command implements \Symfony\Component\Console\Command\SignalableCommandInterface
{
    ...
    {
        return $this->command instanceof \Symfony\Component\Console\Command\SignalableCommandInterface ? $this->command->getSubscribedSignals() : [];
    }
    public function handleSignal(int $signal, int|false $previousExitCode = 0): int|false
    {
        if (!$this->command instanceof \Symfony\Component\Console\Command\SignalableCommandInterface) {
            return \false;
        }
