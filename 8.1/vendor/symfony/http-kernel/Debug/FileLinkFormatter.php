...
trigger_deprecation('symfony/http-kernel', '6.4', 'The "%s" class is deprecated, use "%s" instead.', \Symfony\Component\HttpKernel\Debug\FileLinkFormatter::class, ErrorHandlerFileLinkFormatter::class);
...
if (!class_exists(\Symfony\Component\HttpKernel\Debug\FileLinkFormatter::class, \false)) {
    class_alias(ErrorHandlerFileLinkFormatter::class, \Symfony\Component\HttpKernel\Debug\FileLinkFormatter::class);
}
if (\false) {
    /**
