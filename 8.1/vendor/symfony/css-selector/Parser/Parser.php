...
class Parser implements \Symfony\Component\CssSelector\Parser\ParserInterface
{
    ...
    public static function parseSeries(array $tokens): array
    {
        ...
        $joined = trim(implode('', array_map(fn(\Symfony\Component\CssSelector\Parser\Token $token) => $token->getValue(), $tokens)));
        $int = function ($string) {
    ...
    private function parseSelectorList(\Symfony\Component\CssSelector\Parser\TokenStream $stream): array
    {
    ...
    private function parserSelectorNode(\Symfony\Component\CssSelector\Parser\TokenStream $stream): Node\SelectorNode
    {
     ...
     * @throws SyntaxErrorException
     */
    private function parseSimpleSelector(\Symfony\Component\CssSelector\Parser\TokenStream $stream, bool $insideNegation = \false): array
    {
        $stream->skipWhitespace();
