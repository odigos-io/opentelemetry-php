...
class HtmlErrorRenderer implements \Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct(bool|callable $debug = \false, ?string $charset = null, string|\Symfony\Component\ErrorHandler\ErrorRenderer\FileLinkFormatter|null $fileLinkFormat = null, ?string $projectDir = null, string|callable $outputBuffer = '', ?LoggerInterface $logger = null)
    {
