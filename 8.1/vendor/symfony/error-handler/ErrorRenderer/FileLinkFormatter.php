...
if (!class_exists(\Odigos\Symfony\Component\HttpKernel\Debug\FileLinkFormatter::class, \false)) {
    class_alias(FileLinkFormatter::class, \Odigos\Symfony\Component\HttpKernel\Debug\FileLinkFormatter::class);
}
