...
final class CreateResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    public static function from(array $attributes, MetaInformation $meta): self
    {
        ...
        return new self($attributes['id'], $attributes['object'], $attributes['created'], $attributes['model'], $attributes['system_fingerprint'] ?? null, $choices, \OpenAI\Responses\Chat\CreateResponseUsage::from($attributes['usage']), $meta);
    }
    /**
     * {@inheritDoc}
     */
