...
{
    private function __construct(public readonly int $index, public readonly \OpenAI\Responses\Chat\CreateResponseMessage $message, public readonly ?string $finishReason)
    {
    }
    /**
    ...
    {
        return new self($attributes['index'], \OpenAI\Responses\Chat\CreateResponseMessage::from($attributes['message']), $attributes['finish_reason'] ?? null);
    }
    /**
