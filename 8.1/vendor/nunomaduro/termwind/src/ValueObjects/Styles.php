...
use Odigos\Termwind\Components\Hr;
use Odigos\Termwind\Components\Li;
use Odigos\Termwind\Components\Ol;
use Odigos\Termwind\Components\Ul;
use Odigos\Termwind\Enums\Color;
use Odigos\Termwind\Exceptions\ColorNotFound;
use Odigos\Termwind\Exceptions\InvalidStyle;
...
final class Styles
{
     ...
     */
    final public function __construct(private array $properties = ['colors' => [], 'options' => [], 'isFirstChild' => \false], private array $textModifiers = [], private array $styleModifiers = [], private array $defaultStyles = [])
    {
    }
    /**
     * @return $this
    ...
    {
        return mb_strlen(preg_replace(self::STYLING_REGEX, '', $text ?? $this->element?->toString() ?? '') ?? '', 'UTF-8');
    }
    /**
