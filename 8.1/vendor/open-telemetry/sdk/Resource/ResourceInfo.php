...
class ResourceInfo
{
    ...
    {
        return new \OpenTelemetry\SDK\Resource\ResourceInfo($attributes, $schemaUrl);
    }
     ...
     */
    public function merge(\OpenTelemetry\SDK\Resource\ResourceInfo $updating): \OpenTelemetry\SDK\Resource\ResourceInfo
    {
        ...
        return \OpenTelemetry\SDK\Resource\ResourceInfo::create($attributes, $schemaUrl);
    }
    /**
    ...
    {
        BcUtil::triggerMethodDeprecationNotice(__METHOD__, 'defaultResource', \OpenTelemetry\SDK\Resource\ResourceInfoFactory::class);
        return \OpenTelemetry\SDK\Resource\ResourceInfoFactory::defaultResource();
    }
    /**
     * @codeCoverageIgnore
     */
    ...
    {
        BcUtil::triggerMethodDeprecationNotice(__METHOD__, 'emptyResource', \OpenTelemetry\SDK\Resource\ResourceInfoFactory::class);
        return \OpenTelemetry\SDK\Resource\ResourceInfoFactory::emptyResource();
    }
}
