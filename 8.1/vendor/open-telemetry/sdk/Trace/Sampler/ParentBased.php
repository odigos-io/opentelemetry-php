...
class ParentBased implements SamplerInterface
{
    ...
    {
        $this->remoteParentSampler = $remoteParentSampler ?? new \OpenTelemetry\SDK\Trace\Sampler\AlwaysOnSampler();
        $this->remoteParentNotSampler = $remoteParentNotSampler ?? new \OpenTelemetry\SDK\Trace\Sampler\AlwaysOffSampler();
        $this->localParentSampler = $localParentSampler ?? new \OpenTelemetry\SDK\Trace\Sampler\AlwaysOnSampler();
        $this->localParentNotSampler = $localParentNotSampler ?? new \OpenTelemetry\SDK\Trace\Sampler\AlwaysOffSampler();
    }
    /**
