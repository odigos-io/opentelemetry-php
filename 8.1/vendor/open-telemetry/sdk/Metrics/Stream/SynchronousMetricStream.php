 ...
 */
final class SynchronousMetricStream implements \OpenTelemetry\SDK\Metrics\Stream\MetricStreamInterface
{
    use LogsMessagesTrait;
    private readonly \OpenTelemetry\SDK\Metrics\Stream\DeltaStorage $delta;
    ...
    {
        $this->delta = new \OpenTelemetry\SDK\Metrics\Stream\DeltaStorage($this->aggregation);
    }
    #[\Override]
    ...
    public function collect(int $reader): DataInterface
    {
        ...
        $metric = $this->delta->collect($reader, $cumulative) ?? new \OpenTelemetry\SDK\Metrics\Stream\Metric([], [], $this->timestamp);
