...
final class PsrTransport implements TransportInterface
{
    ...
    public function send(string $payload, ?CancellationInterface $cancellation = null): FutureInterface
    {
        ...
        $body = \OpenTelemetry\SDK\Common\Export\Http\PsrUtils::encode($payload, $this->compression, $appliedEncodings);
        ...
        for ($retries = 0;; $retries++) {
            ...
            $delay = \OpenTelemetry\SDK\Common\Export\Http\PsrUtils::retryDelay($retries, $this->retryDelay, $response);
            $sec = (int) $delay;
        ...
        try {
            $body = \OpenTelemetry\SDK\Common\Export\Http\PsrUtils::decode($response->getBody()->__toString(), self::parseContentEncoding($response));
        } catch (Throwable $e) {
            return new ErrorFuture($e);
        }
