...
namespace Odigos\Opentelemetry\Proto\Trace\V1;
 ...
 */
class Span extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Odigos\GPBMetadata\Opentelemetry\Proto\Trace\V1\Trace::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Opentelemetry\Proto\Trace\V1\Span\SpanKind::class);
        $this->kind = $var;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Common\V1\KeyValue::class);
        $this->attributes = $arr;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Trace\V1\Span\Event::class);
        $this->events = $arr;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Trace\V1\Span\Link::class);
        $this->links = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Trace\V1\Status::class);
        $this->status = $var;
        return $this;
    }
}
