 ...
 */
class TraceConfig extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Odigos\GPBMetadata\Opentelemetry\Proto\Trace\V1\TraceConfig::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Trace\V1\ConstantSampler::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Trace\V1\TraceIdRatioBased::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Trace\V1\RateLimitingSampler::class);
