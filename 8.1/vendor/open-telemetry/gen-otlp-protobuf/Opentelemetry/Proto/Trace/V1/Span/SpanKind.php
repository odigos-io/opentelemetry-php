...
class SpanKind
{
    ...
    private static $valueToName = [self::SPAN_KIND_UNSPECIFIED => 'SPAN_KIND_UNSPECIFIED', self::SPAN_KIND_INTERNAL => 'SPAN_KIND_INTERNAL', self::SPAN_KIND_SERVER => 'SPAN_KIND_SERVER', self::SPAN_KIND_CLIENT => 'SPAN_KIND_CLIENT', self::SPAN_KIND_PRODUCER => 'SPAN_KIND_PRODUCER', self::SPAN_KIND_CONSUMER => 'SPAN_KIND_CONSUMER'];
...
class_alias(SpanKind::class, \Odigos\Opentelemetry\Proto\Trace\V1\Span_SpanKind::class);
