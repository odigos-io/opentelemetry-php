 ...
 */
class ExportProfilesServiceResponse extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Collector\Profiles\V1development\ExportProfilesPartialSuccess::class);
