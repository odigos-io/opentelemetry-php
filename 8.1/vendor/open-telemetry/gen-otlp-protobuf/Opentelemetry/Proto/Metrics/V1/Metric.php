...
namespace Odigos\Opentelemetry\Proto\Metrics\V1;
 ...
 */
class Metric extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
     * name of the metric.
     *
    ...
    {
        \Odigos\GPBMetadata\Opentelemetry\Proto\Metrics\V1\Metrics::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Metrics\V1\Gauge::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Metrics\V1\Sum::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Metrics\V1\Histogram::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Metrics\V1\ExponentialHistogram::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Metrics\V1\Summary::class);
