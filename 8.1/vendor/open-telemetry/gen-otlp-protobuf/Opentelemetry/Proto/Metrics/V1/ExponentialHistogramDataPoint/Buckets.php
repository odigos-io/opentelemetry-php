...
namespace Odigos\Opentelemetry\Proto\Metrics\V1\ExponentialHistogramDataPoint;
 ...
 */
class Buckets extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::UINT64);
        $this->bucket_counts = $arr;
        return $this;
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
class_alias(Buckets::class, \Odigos\Opentelemetry\Proto\Metrics\V1\ExponentialHistogramDataPoint_Buckets::class);
