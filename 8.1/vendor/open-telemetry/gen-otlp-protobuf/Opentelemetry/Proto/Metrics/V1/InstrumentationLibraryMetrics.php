 ...
 */
class InstrumentationLibraryMetrics extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Common\V1\InstrumentationLibrary::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Metrics\V1\Metric::class);
        $this->metrics = $arr;
        return $this;
    }
    /**
