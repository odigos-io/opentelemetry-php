 ...
 */
class ScopeProfiles extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Common\V1\InstrumentationScope::class);
        $this->scope = $var;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Profiles\V1development\Profile::class);
        $this->profiles = $arr;
        return $this;
    }
    /**
