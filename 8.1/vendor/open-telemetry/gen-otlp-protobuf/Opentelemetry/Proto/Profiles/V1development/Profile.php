 ...
 */
class Profile extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Profiles\V1development\ValueType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Profiles\V1development\Sample::class);
        $this->sample = $arr;
        return $this;
    }
    /**
