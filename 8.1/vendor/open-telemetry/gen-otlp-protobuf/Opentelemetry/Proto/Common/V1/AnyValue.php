...
namespace Odigos\Opentelemetry\Proto\Common\V1;
 ...
 */
class AnyValue extends \Odigos\Google\Protobuf\Internal\Message
{
    protected $value;
    /**
     * Constructor.
    ...
    {
        \Odigos\GPBMetadata\Opentelemetry\Proto\Common\V1\Common::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Common\V1\ArrayValue::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Common\V1\KeyValueList::class);
