...
final class CommonClassesStrategy implements \Http\Discovery\Strategy\DiscoveryStrategy
{
    ...
    {
        return new \Odigos\Buzz\Client\FileGetContents(Psr17FactoryDiscovery::findResponseFactory());
    }
