...
class Client implements \GuzzleHttp\ClientInterface, \Psr\Http\Client\ClientInterface
{
    ...
    {
        $defaults = ['allow_redirects' => \GuzzleHttp\RedirectMiddleware::$defaultSettings, 'http_errors' => \true, 'decode_content' => \true, 'verify' => \true, 'cookies' => \false, 'idn_conversion' => \false];
