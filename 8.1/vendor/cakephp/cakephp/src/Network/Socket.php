...
class Socket
{
     ...
     */
    protected array $_defaultConfig = ['persistent' => \false, 'host' => 'localhost', 'protocol' => 'tcp', 'port' => 80, 'timeout' => 30];
    /**
    ...
    public function connect(): bool
    {
        ...
        $errNum = 0;
        $errStr = '';
        $this->connection = $this->_getStreamSocketClient($remoteSocketTarget, $errNum, $errStr, (int) $this->_config['timeout'], $connectAs, $context);
     ...
     */
    protected function _getStreamSocketClient(string $remoteSocketTarget, int &$errNum, string &$errStr, int $timeout, int $connectAs, $context)
    {
        $resource = stream_socket_client($remoteSocketTarget, $errNum, $errStr, $timeout, $connectAs, $context);
        if (!$resource) {
            return null;
        }
        return $resource;
    ...
    protected function _setSslContext(string $host): void
    {
        ...
        $this->_config['context']['ssl']['SNI_enabled'] ??= \true;
     ...
     */
    public function enableCrypto(string $type, string $clientOrServer = 'client', bool $enable = \true): void
    {
