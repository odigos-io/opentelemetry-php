...
class IdentifierQuoter
{
     ...
     */
    public function __construct(protected string $startQuote, protected string $endQuote)
    {
    }
    /**
    ...
    public function quote(\Cake\Database\Query $query): \Cake\Database\Query
    {
        ...
        match (\true) {
            ...
            default => throw new DatabaseException(sprintf('Instance of SelectQuery, UpdateQuery, InsertQuery, DeleteQuery expected. Found `%s` instead.', get_debug_type($query))),
        };
