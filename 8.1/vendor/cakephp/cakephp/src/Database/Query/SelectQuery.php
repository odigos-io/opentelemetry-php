...
class SelectQuery extends Query implements IteratorAggregate
{
     ...
     */
    protected array $_parts = ['comment' => null, 'modifier' => [], 'with' => [], 'select' => [], 'distinct' => \false, 'from' => [], 'join' => [], 'where' => null, 'group' => [], 'having' => null, 'window' => [], 'order' => null, 'limit' => null, 'offset' => null, 'union' => [], 'epilog' => null, 'intersect' => []];
    /**
