...
class Mysql extends Driver
{
     ...
     */
    protected array $featureVersions = ['mysql' => ['json' => '5.7.0', 'cte' => '8.0.0', 'window' => '8.0.0', 'intersect' => '8.0.31', 'intersect-all' => '8.0.31'], 'mariadb' => ['json' => '10.2.7', 'cte' => '10.2.1', 'window' => '10.2.0', 'intersect' => '10.3.0', 'intersect-all' => '10.5.0']];
    /**
     * @inheritDoc
     */
    public function connect(): void
    {
        ...
        $config['flags'] += [PDO::ATTR_PERSISTENT => $config['persistent'], self::attrUseBufferedQueryId() => \true, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION];
    ...
    public function run(Query $query): StatementInterface
    {
        ...
        if ($query instanceof SelectQuery) {
            try {
                ...
                $this->getPdo()->setAttribute(self::attrUseBufferedQueryId(), \true);
            }
        } else {
            $this->executeStatement($statement);
        }
