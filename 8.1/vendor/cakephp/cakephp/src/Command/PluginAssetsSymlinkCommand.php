...
class PluginAssetsSymlinkCommand extends \Cake\Command\Command
{
    ...
    {
        $parser->setDescription(static::getDescription())->addArgument('name', ['help' => 'A specific plugin you want to symlink assets for.', 'required' => \false])->addOption('overwrite', ['help' => 'Overwrite existing symlink / folder / files.', 'default' => \false, 'boolean' => \true]);
        return $parser;
    }
}
