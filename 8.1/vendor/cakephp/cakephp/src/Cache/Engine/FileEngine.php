...
class FileEngine extends CacheEngine
{
     ...
     */
    protected array $_defaultConfig = ['duration' => 3600, 'groups' => [], 'lock' => \true, 'mask' => 0664, 'dirMask' => 0770, 'path' => null, 'prefix' => 'cake_', 'serialize' => \true];
    /**
    ...
    protected function _setKey(string $key, bool $createKey = \false): bool
    {
        ...
        if (!is_dir($dir)) {
            mkdir($dir, $this->_config['dirMask'], \true);
        }
    ...
    protected function _active(): bool
    {
        ...
        if (!is_dir($path)) {
            // phpcs:disable
            $success = @mkdir($path, $this->_config['dirMask'], \true);
            // phpcs:enable
        }
