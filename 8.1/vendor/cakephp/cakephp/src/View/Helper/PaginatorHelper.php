...
class PaginatorHelper extends Helper
{
    ...
    public function limitControl(array $limits = [], ?int $default = null, array $options = []): string
    {
        ...
        $out .= $this->Form->control($scope . 'limit', $options + ['type' => 'select', 'label' => __('View'), 'default' => $default, 'value' => $this->_View->getRequest()->getQuery('limit'), 'options' => $limits, 'onChange' => 'this.form.submit()']);
        $out .= $this->Form->end();
        return $out;
    }
    /**
