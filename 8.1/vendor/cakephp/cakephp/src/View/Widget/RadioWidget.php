...
class RadioWidget extends \Cake\View\Widget\BasicWidget
{
     ...
     */
    protected array $defaults = ['name' => '', 'options' => [], 'disabled' => null, 'val' => null, 'escape' => \true, 'label' => \true, 'empty' => \false, 'idPrefix' => null, 'templateVars' => []];
    /**
     * Label instance.
     *
    ...
    protected function _renderInput(string|int $val, array|string|int $text, array $data, ContextInterface $context): string
    {
        ...
        if ($label === \false && !str_contains($this->_templates->get('radioWrapper'), '{{input}}')) {
            $label = $input;
        }
