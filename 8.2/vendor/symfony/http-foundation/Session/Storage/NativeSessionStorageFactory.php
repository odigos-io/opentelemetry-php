...
class NativeSessionStorageFactory implements \Symfony\Component\HttpFoundation\Session\Storage\SessionStorageFactoryInterface
{
     ...
     */
    public function __construct(private array $options = [], private AbstractProxy|\SessionHandlerInterface|null $handler = null, private ?\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null, private bool $secure = \false)
    {
    }
