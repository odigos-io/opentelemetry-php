...
final class CreateResponseChoice
{
    ...
    {
        return new self($attributes['text'], $attributes['index'], isset($attributes['logprobs']) ? \OpenAI\Responses\Completions\CreateResponseChoiceLogprobs::from($attributes['logprobs']) : null, $attributes['finish_reason']);
    }
    /**
