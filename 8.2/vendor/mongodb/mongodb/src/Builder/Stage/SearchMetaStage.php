...
final class SearchMetaStage implements InputStageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['operator' => null, 'index' => 'index', 'count' => 'count', 'returnScope' => 'returnScope', 'returnStoredSource' => 'returnStoredSource'];
    /**
     ...
     */
    public function __construct(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $returnScope = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined)
    {
