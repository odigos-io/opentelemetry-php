...
final class GeoNearStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['near' => 'near', 'distanceField' => 'distanceField', 'distanceMultiplier' => 'distanceMultiplier', 'includeLocs' => 'includeLocs', 'key' => 'key', 'maxDistance' => 'maxDistance', 'minDistance' => 'minDistance', 'query' => 'query', 'spherical' => 'spherical'];
