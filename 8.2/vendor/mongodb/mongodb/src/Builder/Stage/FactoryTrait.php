...
trait FactoryTrait
{
     ...
     */
    public static function addFields(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$expression): \MongoDB\Builder\Stage\AddFieldsStage
    {
        return new \MongoDB\Builder\Stage\AddFieldsStage(...$expression);
    }
    /**
     ...
     */
    public static function bucket(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $groupBy, PackedArray|BSONArray|array $boundaries, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $default = Optional::Undefined, Optional|Document|Serializable|stdClass|array $output = Optional::Undefined): \MongoDB\Builder\Stage\BucketStage
    {
        return new \MongoDB\Builder\Stage\BucketStage($groupBy, $boundaries, $default, $output);
    }
    /**
     ...
     */
    public static function bucketAuto(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $groupBy, int $buckets, Optional|Document|Serializable|stdClass|array $output = Optional::Undefined, Optional|string $granularity = Optional::Undefined): \MongoDB\Builder\Stage\BucketAutoStage
    {
        return new \MongoDB\Builder\Stage\BucketAutoStage($groupBy, $buckets, $output, $granularity);
    }
    /**
     ...
     */
    public static function changeStream(Optional|bool $allChangesForCluster = Optional::Undefined, Optional|string $fullDocument = Optional::Undefined, Optional|string $fullDocumentBeforeChange = Optional::Undefined, Optional|int $resumeAfter = Optional::Undefined, Optional|bool $showExpandedEvents = Optional::Undefined, Optional|Document|Serializable|stdClass|array $startAfter = Optional::Undefined, Optional|Timestamp|int $startAtOperationTime = Optional::Undefined): \MongoDB\Builder\Stage\ChangeStreamStage
    {
        return new \MongoDB\Builder\Stage\ChangeStreamStage($allChangesForCluster, $fullDocument, $fullDocumentBeforeChange, $resumeAfter, $showExpandedEvents, $startAfter, $startAtOperationTime);
    }
    /**
     ...
     */
    public static function changeStreamSplitLargeEvent(): \MongoDB\Builder\Stage\ChangeStreamSplitLargeEventStage
    {
        return new \MongoDB\Builder\Stage\ChangeStreamSplitLargeEventStage();
    }
    /**
     ...
     */
    public static function collStats(Optional|Document|Serializable|stdClass|array $latencyStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $storageStats = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|Document|Serializable|stdClass|array $queryExecStats = Optional::Undefined): \MongoDB\Builder\Stage\CollStatsStage
    {
        return new \MongoDB\Builder\Stage\CollStatsStage($latencyStats, $storageStats, $count, $queryExecStats);
    }
    /**
     ...
     */
    public static function count(string $field): \MongoDB\Builder\Stage\CountStage
    {
        return new \MongoDB\Builder\Stage\CountStage($field);
    }
    /**
     ...
     */
    public static function currentOp(Optional|bool $allUsers = Optional::Undefined, Optional|bool $idleConnections = Optional::Undefined, Optional|bool $idleCursors = Optional::Undefined, Optional|bool $idleSessions = Optional::Undefined, Optional|bool $localOps = Optional::Undefined): \MongoDB\Builder\Stage\CurrentOpStage
    {
        return new \MongoDB\Builder\Stage\CurrentOpStage($allUsers, $idleConnections, $idleCursors, $idleSessions, $localOps);
    }
    /**
     ...
     */
    public static function densify(string $field, Document|Serializable|stdClass|array $range, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined): \MongoDB\Builder\Stage\DensifyStage
    {
        return new \MongoDB\Builder\Stage\DensifyStage($field, $range, $partitionByFields);
    }
    /**
     ...
     */
    public static function documents(PackedArray|ResolvesToArray|BSONArray|array|string $documents): \MongoDB\Builder\Stage\DocumentsStage
    {
        return new \MongoDB\Builder\Stage\DocumentsStage($documents);
    }
    /**
     ...
     */
    public static function facet(PackedArray|Pipeline|BSONArray|array ...$facet): \MongoDB\Builder\Stage\FacetStage
    {
        return new \MongoDB\Builder\Stage\FacetStage(...$facet);
    }
    /**
     ...
     */
    public static function fill(Document|Serializable|stdClass|array $output, Optional|Document|Serializable|stdClass|array|string $partitionBy = Optional::Undefined, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sortBy = Optional::Undefined): \MongoDB\Builder\Stage\FillStage
    {
        return new \MongoDB\Builder\Stage\FillStage($output, $partitionBy, $partitionByFields, $sortBy);
    }
    /**
     ...
     */
    public static function graphLookup(string $from, DateTimeInterface|PackedArray|Type|ExpressionInterface|BSONArray|stdClass|array|bool|float|int|null|string $startWith, string $connectFromField, string $connectToField, string $as, Optional|int $maxDepth = Optional::Undefined, Optional|string $depthField = Optional::Undefined, Optional|QueryInterface|array $restrictSearchWithMatch = Optional::Undefined): \MongoDB\Builder\Stage\GraphLookupStage
    {
        return new \MongoDB\Builder\Stage\GraphLookupStage($from, $startWith, $connectFromField, $connectToField, $as, $maxDepth, $depthField, $restrictSearchWithMatch);
    }
    /**
     ...
     */
    public static function group(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $_id, Document|Serializable|AccumulatorInterface|stdClass|array ...$field): \MongoDB\Builder\Stage\GroupStage
    {
        return new \MongoDB\Builder\Stage\GroupStage($_id, ...$field);
    }
    /**
     ...
     */
    public static function indexStats(): \MongoDB\Builder\Stage\IndexStatsStage
    {
        return new \MongoDB\Builder\Stage\IndexStatsStage();
    }
    /**
     ...
     * @param int $limit
     */
    public static function limit(int $limit): \MongoDB\Builder\Stage\LimitStage
    {
        return new \MongoDB\Builder\Stage\LimitStage($limit);
    }
    /**
     ...
     */
    public static function listLocalSessions(Optional|PackedArray|BSONArray|array $users = Optional::Undefined, Optional|bool $allUsers = Optional::Undefined): \MongoDB\Builder\Stage\ListLocalSessionsStage
    {
        return new \MongoDB\Builder\Stage\ListLocalSessionsStage($users, $allUsers);
    }
    /**
     ...
     */
    public static function listSampledQueries(Optional|string $namespace = Optional::Undefined): \MongoDB\Builder\Stage\ListSampledQueriesStage
    {
        return new \MongoDB\Builder\Stage\ListSampledQueriesStage($namespace);
    }
    /**
     ...
     */
    public static function listSearchIndexes(Optional|string $id = Optional::Undefined, Optional|string $name = Optional::Undefined): \MongoDB\Builder\Stage\ListSearchIndexesStage
    {
        return new \MongoDB\Builder\Stage\ListSearchIndexesStage($id, $name);
    }
    /**
     ...
     * @param Optional|bool $allUsers Returns all sessions for all users. If running with access control, the authenticated user must have privileges with listSessions action on the cluster.
     */
    public static function listSessions(Optional|PackedArray|BSONArray|array $users = Optional::Undefined, Optional|bool $allUsers = Optional::Undefined): \MongoDB\Builder\Stage\ListSessionsStage
    {
        return new \MongoDB\Builder\Stage\ListSessionsStage($users, $allUsers);
    }
    /**
     ...
     */
    public static function lookup(string $as, Optional|string $from = Optional::Undefined, Optional|string $localField = Optional::Undefined, Optional|string $foreignField = Optional::Undefined, Optional|Document|Serializable|stdClass|array $let = Optional::Undefined, Optional|PackedArray|Pipeline|BSONArray|array $pipeline = Optional::Undefined): \MongoDB\Builder\Stage\LookupStage
    {
        return new \MongoDB\Builder\Stage\LookupStage($as, $from, $localField, $foreignField, $let, $pipeline);
    }
    /**
     ...
     */
    public static function match(QueryInterface|array $query): \MongoDB\Builder\Stage\MatchStage
    {
        return new \MongoDB\Builder\Stage\MatchStage($query);
    }
    /**
     ...
     */
    public static function merge(Document|Serializable|stdClass|array|string $into, Optional|PackedArray|BSONArray|array|string $on = Optional::Undefined, Optional|Document|Serializable|stdClass|array $let = Optional::Undefined, Optional|PackedArray|Pipeline|BSONArray|array|string $whenMatched = Optional::Undefined, Optional|string $whenNotMatched = Optional::Undefined): \MongoDB\Builder\Stage\MergeStage
    {
        return new \MongoDB\Builder\Stage\MergeStage($into, $on, $let, $whenMatched, $whenNotMatched);
    }
    /**
     ...
     */
    public static function out(Document|Serializable|stdClass|array|string $coll): \MongoDB\Builder\Stage\OutStage
    {
        return new \MongoDB\Builder\Stage\OutStage($coll);
    }
    /**
     ...
     */
    public static function planCacheStats(): \MongoDB\Builder\Stage\PlanCacheStatsStage
    {
        return new \MongoDB\Builder\Stage\PlanCacheStatsStage();
    }
    /**
     ...
     */
    public static function project(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$specification): \MongoDB\Builder\Stage\ProjectStage
    {
        return new \MongoDB\Builder\Stage\ProjectStage(...$specification);
    }
    /**
     ...
     */
    public static function redact(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): \MongoDB\Builder\Stage\RedactStage
    {
        return new \MongoDB\Builder\Stage\RedactStage($expression);
    }
    /**
     ...
     */
    public static function replaceRoot(Document|Serializable|ResolvesToObject|stdClass|array|string $newRoot): \MongoDB\Builder\Stage\ReplaceRootStage
    {
        return new \MongoDB\Builder\Stage\ReplaceRootStage($newRoot);
    }
    /**
     * Replaces a document with the specified embedded document. The operation replaces all existing fields in the input document, including the _id field. Specify a document embedded in the input document to promote the embedded document to the top level.
     ...
     */
    public static function replaceWith(Document|Serializable|ResolvesToObject|stdClass|array|string $expression): \MongoDB\Builder\Stage\ReplaceWithStage
    {
        return new \MongoDB\Builder\Stage\ReplaceWithStage($expression);
    }
    /**
     ...
     */
    public static function sample(int $size): \MongoDB\Builder\Stage\SampleStage
    {
        return new \MongoDB\Builder\Stage\SampleStage($size);
    }
    /**
     ...
     */
    public static function search(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $highlight = Optional::Undefined, Optional|bool $concurrent = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined, Optional|string $searchAfter = Optional::Undefined, Optional|string $searchBefore = Optional::Undefined, Optional|bool $scoreDetails = Optional::Undefined, Optional|Document|Serializable|stdClass|array $sort = Optional::Undefined, Optional|bool $returnStoredSource = Optional::Undefined, Optional|Document|Serializable|stdClass|array $tracking = Optional::Undefined): \MongoDB\Builder\Stage\SearchStage
    {
        return new \MongoDB\Builder\Stage\SearchStage($operator, $index, $highlight, $concurrent, $count, $searchAfter, $searchBefore, $scoreDetails, $sort, $returnStoredSource, $tracking);
    }
    /**
     ...
     * @param Optional|Document|Serializable|array|stdClass $count Document that specifies the count options for retrieving a count of the results.
     */
    public static function searchMeta(Document|Serializable|SearchOperatorInterface|stdClass|array $operator, Optional|string $index = Optional::Undefined, Optional|Document|Serializable|stdClass|array $count = Optional::Undefined): \MongoDB\Builder\Stage\SearchMetaStage
    {
        return new \MongoDB\Builder\Stage\SearchMetaStage($operator, $index, $count);
    }
    /**
     * Adds new fields to documents. Outputs documents that contain all existing fields from the input documents and newly added fields.
     * Alias for $addFields.
     ...
     */
    public static function set(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string ...$field): \MongoDB\Builder\Stage\SetStage
    {
        return new \MongoDB\Builder\Stage\SetStage(...$field);
    }
    /**
     ...
     */
    public static function setWindowFields(Document|Serializable|stdClass|array $sortBy, Document|Serializable|stdClass|array $output, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $partitionBy = Optional::Undefined): \MongoDB\Builder\Stage\SetWindowFieldsStage
    {
        return new \MongoDB\Builder\Stage\SetWindowFieldsStage($sortBy, $output, $partitionBy);
    }
    /**
     ...
     */
    public static function shardedDataDistribution(): \MongoDB\Builder\Stage\ShardedDataDistributionStage
    {
        return new \MongoDB\Builder\Stage\ShardedDataDistributionStage();
    }
    /**
     ...
     * @param int $skip
     */
    public static function skip(int $skip): \MongoDB\Builder\Stage\SkipStage
    {
        return new \MongoDB\Builder\Stage\SkipStage($skip);
    }
    /**
     ...
     */
    public static function sort(DateTimeInterface|Type|ExpressionInterface|Sort|stdClass|array|bool|float|int|null|string ...$sort): \MongoDB\Builder\Stage\SortStage
    {
        return new \MongoDB\Builder\Stage\SortStage(...$sort);
    }
    /**
     ...
     * @param DateTimeInterface|ExpressionInterface|Type|array|bool|float|int|null|stdClass|string $expression
     */
    public static function sortByCount(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $expression): \MongoDB\Builder\Stage\SortByCountStage
    {
        return new \MongoDB\Builder\Stage\SortByCountStage($expression);
    }
    /**
     ...
     */
    public static function unionWith(string $coll, Optional|PackedArray|Pipeline|BSONArray|array $pipeline = Optional::Undefined): \MongoDB\Builder\Stage\UnionWithStage
    {
        return new \MongoDB\Builder\Stage\UnionWithStage($coll, $pipeline);
    }
    /**
     ...
     */
    public static function unset(FieldPath|string ...$field): \MongoDB\Builder\Stage\UnsetStage
    {
        return new \MongoDB\Builder\Stage\UnsetStage(...$field);
    }
    /**
     ...
     */
    public static function unwind(ArrayFieldPath|string $path, Optional|string $includeArrayIndex = Optional::Undefined, Optional|bool $preserveNullAndEmptyArrays = Optional::Undefined): \MongoDB\Builder\Stage\UnwindStage
    {
        return new \MongoDB\Builder\Stage\UnwindStage($path, $includeArrayIndex, $preserveNullAndEmptyArrays);
    }
    /**
     ...
     */
    public static function vectorSearch(string $index, int $limit, string $path, PackedArray|BSONArray|array $queryVector, Optional|bool $exact = Optional::Undefined, Optional|QueryInterface|array $filter = Optional::Undefined, Optional|int $numCandidates = Optional::Undefined): \MongoDB\Builder\Stage\VectorSearchStage
    {
        return new \MongoDB\Builder\Stage\VectorSearchStage($index, $limit, $path, $queryVector, $exact, $filter, $numCandidates);
    }
}
