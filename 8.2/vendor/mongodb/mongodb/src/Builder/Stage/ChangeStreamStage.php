...
final class ChangeStreamStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['allChangesForCluster' => 'allChangesForCluster', 'fullDocument' => 'fullDocument', 'fullDocumentBeforeChange' => 'fullDocumentBeforeChange', 'resumeAfter' => 'resumeAfter', 'showExpandedEvents' => 'showExpandedEvents', 'startAfter' => 'startAfter', 'startAtOperationTime' => 'startAtOperationTime'];
     ...
     */
    public function __construct(Optional|bool $allChangesForCluster = Optional::Undefined, Optional|string $fullDocument = Optional::Undefined, Optional|string $fullDocumentBeforeChange = Optional::Undefined, Optional|int $resumeAfter = Optional::Undefined, Optional|bool $showExpandedEvents = Optional::Undefined, Optional|Document|Serializable|stdClass|array $startAfter = Optional::Undefined, Optional|Timestamp|int $startAtOperationTime = Optional::Undefined)
    {
