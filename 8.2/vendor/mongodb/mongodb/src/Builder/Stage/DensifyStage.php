...
final class DensifyStage implements StageInterface, OperatorInterface
{
     ...
     */
    public function __construct(string $field, Document|Serializable|stdClass|array $range, Optional|PackedArray|BSONArray|array $partitionByFields = Optional::Undefined)
    {
        $this->field = $field;
        $this->range = $range;
