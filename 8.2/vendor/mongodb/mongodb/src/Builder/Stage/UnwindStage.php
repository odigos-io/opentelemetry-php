...
final class UnwindStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['path' => 'path', 'includeArrayIndex' => 'includeArrayIndex', 'preserveNullAndEmptyArrays' => 'preserveNullAndEmptyArrays'];
     ...
     * The default value is false.
     */
    public function __construct(ArrayFieldPath|string $path, Optional|string $includeArrayIndex = Optional::Undefined, Optional|bool $preserveNullAndEmptyArrays = Optional::Undefined)
    {
        $this->path = $path;
