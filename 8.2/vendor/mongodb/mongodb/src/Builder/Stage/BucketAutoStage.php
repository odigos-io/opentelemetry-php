...
final class BucketAutoStage implements StageInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['groupBy' => 'groupBy', 'buckets' => 'buckets', 'output' => 'output', 'granularity' => 'granularity'];
     ...
     * Available only if the all groupBy values are numeric and none of them are NaN.
     */
    public function __construct(DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $groupBy, int $buckets, Optional|Document|Serializable|stdClass|array $output = Optional::Undefined, Optional|string $granularity = Optional::Undefined)
    {
