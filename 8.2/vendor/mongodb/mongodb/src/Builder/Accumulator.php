...
{
    use \MongoDB\Builder\Accumulator\FactoryTrait;
    /**
     ...
     */
    public static function outputWindow(Document|Serializable|WindowInterface|stdClass|array $operator, Optional|array $documents = Optional::Undefined, Optional|array $range = Optional::Undefined, Optional|TimeUnit|string $unit = Optional::Undefined): OutputWindow
    {
