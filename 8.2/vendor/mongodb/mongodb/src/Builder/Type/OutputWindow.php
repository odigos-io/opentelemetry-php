...
final class OutputWindow implements WindowInterface
{
     ...
     */
    public function __construct(Document|Serializable|WindowInterface|stdClass|array $operator, Optional|array $documents = Optional::Undefined, Optional|array $range = Optional::Undefined, Optional|TimeUnit|string $unit = Optional::Undefined)
    {
