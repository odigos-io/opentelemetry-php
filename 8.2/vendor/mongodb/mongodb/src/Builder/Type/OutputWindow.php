 ...
 */
final class OutputWindow implements \MongoDB\Builder\Type\WindowInterface
{
    /**
     ...
     */
    public Document|Serializable|\MongoDB\Builder\Type\WindowInterface|stdClass|array $operator;
    /**
     * Specifies the window boundaries and parameters.
     */
    public \MongoDB\Builder\Type\Optional|stdClass $window;
    /**
     ...
     */
    public function __construct(Document|Serializable|\MongoDB\Builder\Type\WindowInterface|stdClass|array $operator, \MongoDB\Builder\Type\Optional|array $documents = \MongoDB\Builder\Type\Optional::Undefined, \MongoDB\Builder\Type\Optional|array $range = \MongoDB\Builder\Type\Optional::Undefined, \MongoDB\Builder\Type\Optional|\MongoDB\Builder\Type\TimeUnit|string $unit = \MongoDB\Builder\Type\Optional::Undefined)
    {
        $this->operator = $operator;
        $window = null;
        if ($documents !== \MongoDB\Builder\Type\Optional::Undefined) {
        ...
        if ($range !== \MongoDB\Builder\Type\Optional::Undefined) {
        ...
        if ($unit !== \MongoDB\Builder\Type\Optional::Undefined) {
            $window ??= new stdClass();
            $window->unit = $unit;
        }
        $this->window = $window ?? \MongoDB\Builder\Type\Optional::Undefined;
    }
}
