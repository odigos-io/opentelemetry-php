...
final class RegexOperator implements SearchOperatorInterface, OperatorInterface
{
    ...
    public const PROPERTIES = ['path' => 'path', 'query' => 'query', 'allowAnalyzedField' => 'allowAnalyzedField', 'score' => 'score'];
     ...
     */
    public function __construct(array|string $path, string $query, Optional|bool $allowAnalyzedField = Optional::Undefined, Optional|Document|Serializable|stdClass|array $score = Optional::Undefined)
    {
        $this->path = $path;
        $this->query = $query;
