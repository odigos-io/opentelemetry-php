...
use Odigos\MongoDB\Builder\Type\SwitchBranchInterface;
...
final class CaseOperator implements SwitchBranchInterface, OperatorInterface
{
     ...
     */
    public function __construct(ResolvesToBool|bool|string $case, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $then)
    {
