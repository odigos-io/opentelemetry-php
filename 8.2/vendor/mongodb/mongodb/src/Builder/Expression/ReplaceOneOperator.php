...
final class ReplaceOneOperator implements ResolvesToString, OperatorInterface
{
     ...
     */
    public function __construct(ResolvesToNull|ResolvesToString|null|string $input, ResolvesToNull|ResolvesToString|null|string $find, ResolvesToNull|ResolvesToString|null|string $replacement)
    {
        $this->input = $input;
        $this->find = $find;
