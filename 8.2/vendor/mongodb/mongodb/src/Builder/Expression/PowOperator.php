 ...
 * @internal
 */
final class PowOperator implements \MongoDB\Builder\Expression\ResolvesToNumber, OperatorInterface
{
    ...
    public readonly Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $exponent;
    /**
     ...
     */
    public function __construct(Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $number, Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $exponent)
    {
