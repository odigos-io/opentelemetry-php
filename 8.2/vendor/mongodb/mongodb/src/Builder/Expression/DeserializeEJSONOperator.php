...
final class DeserializeEJSONOperator implements ResolvesToObject, OperatorInterface
{
     ...
     * If unspecified, the operation throws an error and stops.
     */
    public function __construct(Document|Serializable|ResolvesToObject|stdClass|array|string $input, Optional|DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $onError = Optional::Undefined)
    {
