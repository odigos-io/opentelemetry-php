 ...
 * @internal
 */
final class SortArrayOperator implements \MongoDB\Builder\Expression\ResolvesToArray, OperatorInterface
{
     ...
     */
    public function __construct(PackedArray|\MongoDB\Builder\Expression\ResolvesToArray|BSONArray|array|string $input, Document|Serializable|Sort|stdClass|array|int $sortBy)
    {
