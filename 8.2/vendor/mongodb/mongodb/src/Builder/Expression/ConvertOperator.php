 ...
 * @internal
 */
final class ConvertOperator implements \MongoDB\Builder\Expression\ResolvesToAny, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToInt|\MongoDB\Builder\Expression\ResolvesToString|int|string $to;
    /**
