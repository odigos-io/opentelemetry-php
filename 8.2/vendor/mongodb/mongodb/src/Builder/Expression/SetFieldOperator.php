...
final class SetFieldOperator implements ResolvesToObject, OperatorInterface
{
     ...
     * Set to $$REMOVE to remove field from the input document.
     */
    public function __construct(ResolvesToString|string $field, Document|Serializable|ResolvesToObject|stdClass|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $value)
    {
        $this->field = $field;
