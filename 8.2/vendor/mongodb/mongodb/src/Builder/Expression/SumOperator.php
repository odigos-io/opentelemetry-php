 ...
 * @internal
 */
final class SumOperator implements \MongoDB\Builder\Expression\ResolvesToNumber, OperatorInterface
{
     ...
     * @no-named-arguments
     */
    public function __construct(Decimal128|Int64|PackedArray|\MongoDB\Builder\Expression\ResolvesToArray|\MongoDB\Builder\Expression\ResolvesToNumber|BSONArray|array|float|int|string ...$expression)
    {
