 ...
 * @internal
 */
final class DateFromPartsOperator implements \MongoDB\Builder\Expression\ResolvesToDate, OperatorInterface
{
    public const ENCODE = Encode::Object;
    public const NAME = '$dateFromParts';
    public const PROPERTIES = ['year' => 'year', 'isoWeekYear' => 'isoWeekYear', 'month' => 'month', 'isoWeek' => 'isoWeek', 'day' => 'day', 'isoDayOfWeek' => 'isoDayOfWeek', 'hour' => 'hour', 'minute' => 'minute', 'second' => 'second', 'millisecond' => 'millisecond', 'timezone' => 'timezone'];
    ...
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $year;
    ...
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $isoWeekYear;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $month Month. Defaults to 1. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $month;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $isoWeek Week of year. Defaults to 1. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $isoWeek;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $day Day of month. Defaults to 1. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $day;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $isoDayOfWeek Day of week (Monday 1 - Sunday 7). Defaults to 1. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $isoDayOfWeek;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $hour Hour. Defaults to 0. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $hour;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $minute Minute. Defaults to 0. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $minute;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $second Second. Defaults to 0. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $second;
    /** @var Optional|Decimal128|Int64|ResolvesToNumber|float|int|string $millisecond Millisecond. Defaults to 0. */
    public readonly Optional|Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $millisecond;
    ...
    public readonly Optional|\MongoDB\Builder\Expression\ResolvesToString|string $timezone;
    /**
