...
final class LetOperator implements \MongoDB\Builder\Expression\ResolvesToAny, OperatorInterface
{
     ...
     */
    public function __construct(Document|Serializable|stdClass|array $vars, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in)
    {
        $this->vars = $vars;
        $this->in = $in;
    }
