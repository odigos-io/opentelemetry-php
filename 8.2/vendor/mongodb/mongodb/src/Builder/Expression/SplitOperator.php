 ...
 * @internal
 */
final class SplitOperator implements \MongoDB\Builder\Expression\ResolvesToArray, OperatorInterface
{
    ...
    public readonly \MongoDB\Builder\Expression\ResolvesToString|string $delimiter;
    /**
     ...
     */
    public function __construct(\MongoDB\Builder\Expression\ResolvesToString|string $string, \MongoDB\Builder\Expression\ResolvesToString|string $delimiter)
    {
        $this->string = $string;
