 ...
 * @internal
 */
final class DegreesToRadiansOperator implements \MongoDB\Builder\Expression\ResolvesToDouble, \MongoDB\Builder\Expression\ResolvesToDecimal, OperatorInterface
{
     ...
     */
    public readonly Decimal128|Int64|\MongoDB\Builder\Expression\ResolvesToNumber|float|int|string $expression;
    /**
