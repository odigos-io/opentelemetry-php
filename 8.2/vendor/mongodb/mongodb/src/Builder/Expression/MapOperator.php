 ...
 * @internal
 */
final class MapOperator implements \MongoDB\Builder\Expression\ResolvesToArray, OperatorInterface
{
    ...
    public readonly Optional|\MongoDB\Builder\Expression\ResolvesToString|string $as;
    /**
     ...
     */
    public function __construct(PackedArray|\MongoDB\Builder\Expression\ResolvesToArray|BSONArray|array|string $input, DateTimeInterface|Type|ExpressionInterface|stdClass|array|bool|float|int|null|string $in, Optional|\MongoDB\Builder\Expression\ResolvesToString|string $as = Optional::Undefined)
    {
