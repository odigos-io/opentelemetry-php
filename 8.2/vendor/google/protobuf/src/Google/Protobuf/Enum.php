 ...
 */
class Enum extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
     * Enum type name.
     *
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\EnumValue::class);
        $this->enumvalue = $arr;
        return $this;
    }
    /**
