 ...
 */
class Value extends \Odigos\Google\Protobuf\Internal\Message
{
    protected $kind;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Google\Protobuf\NullValue::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\Struct::class);
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\ListValue::class);
