 ...
 */
class FileDescriptorProto extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::INT32);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Google\Protobuf\Internal\ServiceDescriptorProto::class);
        $this->service = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\Internal\FileOptions::class);
        $this->options = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Google\Protobuf\Internal\SourceCodeInfo::class);
