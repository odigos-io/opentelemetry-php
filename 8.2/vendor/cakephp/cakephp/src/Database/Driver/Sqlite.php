...
class Sqlite extends Driver
{
     ...
     */
    protected array $_baseConfig = ['persistent' => \false, 'username' => null, 'password' => null, 'database' => ':memory:', 'encoding' => 'utf8', 'mask' => 0644, 'cache' => null, 'mode' => null, 'flags' => [], 'init' => []];
    /**
     ...
     */
    protected array $_dateParts = ['day' => 'd', 'hour' => 'H', 'month' => 'm', 'minute' => 'M', 'second' => 'S', 'week' => 'W', 'year' => 'Y'];
    /**
     * Mapping of feature to db server version for feature availability checks.
     *
     * @var array<string, string>
     */
    protected array $featureVersions = ['cte' => '3.8.3', 'window' => '3.28.0'];
    /**
     * @inheritDoc
     */
    ...
    public function supports(DriverFeatureEnum $feature): bool
    {
        return match ($feature) {
            DriverFeatureEnum::DISABLE_CONSTRAINT_WITHOUT_TRANSACTION, DriverFeatureEnum::SAVEPOINT, DriverFeatureEnum::TRUNCATE_WITH_CONSTRAINTS => \true,
            DriverFeatureEnum::JSON => \false,
            DriverFeatureEnum::CTE, DriverFeatureEnum::WINDOW => version_compare($this->version(), $this->featureVersions[$feature->value], '>='),
            ...
            DriverFeatureEnum::CHECK_CONSTRAINTS => \true,
        };
    }
    /**
     * @inheritDoc
