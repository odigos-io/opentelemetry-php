...
final class Process implements ResourceDetectorInterface
{
    ...
    {
        $attributes = [ResourceAttributes::PROCESS_RUNTIME_NAME => php_sapi_name(), ResourceAttributes::PROCESS_RUNTIME_VERSION => PHP_VERSION, ResourceAttributes::PROCESS_PID => getmypid(), ResourceAttributes::PROCESS_EXECUTABLE_PATH => PHP_BINARY];
        /**
         * @psalm-suppress PossiblyUndefinedArrayOffset
         */
