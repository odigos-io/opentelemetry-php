...
class LogRecordLimitsBuilder
{
     ...
     */
    public function setAttributeCountLimit(int $attributeCountLimit): \OpenTelemetry\SDK\Logs\LogRecordLimitsBuilder
    {
     ...
     */
    public function setAttributeValueLengthLimit(int $attributeValueLengthLimit): \OpenTelemetry\SDK\Logs\LogRecordLimitsBuilder
    {
     ...
     */
    public function build(): \OpenTelemetry\SDK\Logs\LogRecordLimits
    {
        ...
        return new \OpenTelemetry\SDK\Logs\LogRecordLimits($attributesFactory);
    }
}
