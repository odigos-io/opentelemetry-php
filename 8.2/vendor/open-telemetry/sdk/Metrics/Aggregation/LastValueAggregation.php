...
{
    #[\Override]
    public function initialize(): \OpenTelemetry\SDK\Metrics\Aggregation\LastValueSummary
    {
        return new \OpenTelemetry\SDK\Metrics\Aggregation\LastValueSummary(null, 0);
    }
    /**
     ...
     */
    #[\Override]
    public function merge($left, $right): \OpenTelemetry\SDK\Metrics\Aggregation\LastValueSummary
    {
     ...
     */
    #[\Override]
    public function diff($left, $right): \OpenTelemetry\SDK\Metrics\Aggregation\LastValueSummary
    {
        return $right->timestamp >= $left->timestamp ? $right : $left;
    }
    /**
