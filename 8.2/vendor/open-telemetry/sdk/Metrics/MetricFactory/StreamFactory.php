...
final class StreamFactory implements MetricFactoryInterface
{
    ...
    {
        $provider = new \OpenTelemetry\SDK\Metrics\MetricFactory\StreamMetricSourceProvider($view, $instrument, $instrumentationScope, $resource, $stream, $metricCollector, $streamId);
