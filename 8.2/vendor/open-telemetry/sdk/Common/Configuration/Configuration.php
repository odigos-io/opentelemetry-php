...
class Configuration
{
    ...
    {
        return (int) self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::INTEGER), $default), \FILTER_VALIDATE_INT);
    }
    public static function getString(string $key, ?string $default = null): string
    {
        return (string) self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::STRING), $default));
    }
    public static function getBoolean(string $key, ?bool $default = null): bool
    {
        $resolved = self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::BOOL), null === $default ? $default : ($default ? 'true' : 'false')));
        try {
    ...
    {
        return MapParser::parse(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::MAP), $default));
    }
    public static function getList(string $key, ?array $default = null): array
    {
        return ListParser::parse(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::LIST), $default));
    }
    public static function getEnum(string $key, ?string $default = null): string
    {
        return (string) self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::ENUM), $default));
    }
    public static function getFloat(string $key, ?float $default = null): float
    {
        return (float) self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::FLOAT), $default), \FILTER_VALIDATE_FLOAT);
    }
    public static function getRatio(string $key, ?float $default = null): float
    {
        return RatioParser::parse(self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, \OpenTelemetry\SDK\Common\Configuration\VariableTypes::RATIO), $default)));
    }
    public static function getKnownValues(string $variableName): ?array
    {
        return ClassConstantAccessor::getValue(\OpenTelemetry\SDK\Common\Configuration\KnownValues::class, $variableName);
    }
    public static function getDefault(string $variableName)
    {
        return ClassConstantAccessor::getValue(\OpenTelemetry\SDK\Common\Configuration\Defaults::class, $variableName);
    }
    public static function getType(string $variableName): ?string
    {
        return ClassConstantAccessor::getValue(\OpenTelemetry\SDK\Common\Configuration\ValueTypes::class, $variableName);
    }
    ...
    private static function validateVariableType(string $variableName, string $type): string
    {
        ...
        if ($variableType !== null && $variableType !== $type && $variableType !== \OpenTelemetry\SDK\Common\Configuration\VariableTypes::MIXED) {
