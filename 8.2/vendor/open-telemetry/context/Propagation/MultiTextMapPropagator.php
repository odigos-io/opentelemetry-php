...
final class MultiTextMapPropagator implements \OpenTelemetry\Context\Propagation\TextMapPropagatorInterface
{
    /** @var list<string> */
    ...
    #[\Override]
    public function extract($carrier, ?\OpenTelemetry\Context\Propagation\PropagationGetterInterface $getter = null, ?ContextInterface $context = null): ContextInterface
    {
    ...
    private function extractFields(array $propagators): array
    {
        return array_values(array_unique(
            ...
            array_merge(...array_map(static fn(\OpenTelemetry\Context\Propagation\TextMapPropagatorInterface $propagator) => $propagator->fields(), $propagators))
        ));
    }
}
