 ...
 */
class ValueType extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Opentelemetry\Proto\Profiles\V1development\AggregationTemporality::class);
