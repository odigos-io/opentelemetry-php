 ...
 */
class ExponentialHistogram extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Odigos\Google\Protobuf\Internal\GPBType::MESSAGE, \Odigos\Opentelemetry\Proto\Metrics\V1\ExponentialHistogramDataPoint::class);
    ...
    {
        GPBUtil::checkEnum($var, \Odigos\Opentelemetry\Proto\Metrics\V1\AggregationTemporality::class);
