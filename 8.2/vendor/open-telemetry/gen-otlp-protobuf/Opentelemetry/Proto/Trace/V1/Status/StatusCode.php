...
namespace Odigos\Opentelemetry\Proto\Trace\V1\Status;
...
class StatusCode
{
    ...
    private static $valueToName = [self::STATUS_CODE_UNSET => 'STATUS_CODE_UNSET', self::STATUS_CODE_OK => 'STATUS_CODE_OK', self::STATUS_CODE_ERROR => 'STATUS_CODE_ERROR'];
...
class_alias(StatusCode::class, \Odigos\Opentelemetry\Proto\Trace\V1\Status_StatusCode::class);
