...
namespace Odigos\Opentelemetry\Proto\Trace\V1\ConstantSampler;
...
class ConstantDecision
{
    ...
    private static $valueToName = [self::ALWAYS_OFF => 'ALWAYS_OFF', self::ALWAYS_ON => 'ALWAYS_ON', self::ALWAYS_PARENT => 'ALWAYS_PARENT'];
...
class_alias(ConstantDecision::class, \Odigos\Opentelemetry\Proto\Trace\V1\ConstantSampler_ConstantDecision::class);
