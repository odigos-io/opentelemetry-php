 ...
 */
class ExportLogsServiceResponse extends \Odigos\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Odigos\Opentelemetry\Proto\Collector\Logs\V1\ExportLogsPartialSuccess::class);
