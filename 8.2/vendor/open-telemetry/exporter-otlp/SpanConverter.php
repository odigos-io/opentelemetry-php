...
use Odigos\Opentelemetry\Proto\Collector\Trace\V1\ExportTraceServiceRequest;
...
use Odigos\Opentelemetry\Proto\Trace\V1\ResourceSpans;
use Odigos\Opentelemetry\Proto\Trace\V1\ScopeSpans;
use Odigos\Opentelemetry\Proto\Trace\V1\Span;
use Odigos\Opentelemetry\Proto\Trace\V1\Span\Event;
use Odigos\Opentelemetry\Proto\Trace\V1\Span\Link;
use Odigos\Opentelemetry\Proto\Trace\V1\Span\SpanKind;
use Odigos\Opentelemetry\Proto\Trace\V1\SpanFlags;
use Odigos\Opentelemetry\Proto\Trace\V1\Status;
use Odigos\Opentelemetry\Proto\Trace\V1\Status\StatusCode;
