 ...
 */
final class SystemClock implements \OpenTelemetry\API\Common\Time\ClockInterface
{
    ...
    {
        return (int) ($wallClockMicroTime * (float) \OpenTelemetry\API\Common\Time\ClockInterface::NANOS_PER_SECOND) - $upTime;
    }
}
