...
use Odigos\Egulias\EmailValidator\Warning\IPV6BadChar;
use Odigos\Egulias\EmailValidator\Result\Reason\CRNoLF;
use Odigos\Egulias\EmailValidator\Warning\IPV6ColonEnd;
use Odigos\Egulias\EmailValidator\Warning\IPV6MaxGroups;
use Odigos\Egulias\EmailValidator\Warning\ObsoleteDTEXT;
use Odigos\Egulias\EmailValidator\Warning\AddressLiteral;
use Odigos\Egulias\EmailValidator\Warning\IPV6ColonStart;
use Odigos\Egulias\EmailValidator\Warning\IPV6Deprecated;
use Odigos\Egulias\EmailValidator\Warning\IPV6GroupCount;
use Odigos\Egulias\EmailValidator\Warning\IPV6DoubleColon;
use Odigos\Egulias\EmailValidator\Result\Reason\ExpectingDTEXT;
use Odigos\Egulias\EmailValidator\Result\Reason\UnusualElements;
use Odigos\Egulias\EmailValidator\Warning\DomainLiteral as WarningDomainLiteral;
