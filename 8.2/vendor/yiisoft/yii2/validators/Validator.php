...
class Validator extends Component
{
    ...
    {
        return !in_array($scenario, $this->except, \true) && (empty($this->on) || in_array($scenario, $this->on, \true));
    }
    /**
    ...
    {
        if (Yii::$app !== null) {
            return \Odigos\Yii::$app->getI18n()->format($message, $params, Yii::$app->language);
        }
        $placeholders = [];
