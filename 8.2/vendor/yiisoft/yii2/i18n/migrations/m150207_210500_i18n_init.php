...
class m150207_210500_i18n_init extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%source_message}}', ['id' => $this->primaryKey(), 'category' => $this->string(), 'message' => $this->text()], $tableOptions);
        $this->createTable('{{%message}}', ['id' => $this->integer()->notNull(), 'language' => $this->string(16)->notNull(), 'translation' => $this->text()], $tableOptions);
 ...
 * @since 2.0.7
 */
\class_alias('Odigos\m150207_210500_i18n_init', 'm150207_210500_i18n_init', \false);
