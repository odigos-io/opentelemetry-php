...
class ViewMakeCommand extends GeneratorCommand
{
    ...
    protected function testClassFullyQualifiedName()
    {
        ...
        $namespacedName = Str::of((new Stringable($name))->replace('/', ' ')->explode(' ')->map(fn($part) => (new Stringable($part))->ucfirst())->implode('\\'))->replace(['-', '_'], ' ')->explode(' ')->map(fn($part) => (new Stringable($part))->ucfirst())->implode('');
