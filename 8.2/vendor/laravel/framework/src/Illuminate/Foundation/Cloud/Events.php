...
class Events
{
    ...
    {
        $socket = stream_socket_client(address: $this->address, error_code: $errorCode, error_message: $errorMessage, timeout: 2, flags: \STREAM_CLIENT_CONNECT | \STREAM_CLIENT_PERSISTENT);
        if ($socket === \false) {
