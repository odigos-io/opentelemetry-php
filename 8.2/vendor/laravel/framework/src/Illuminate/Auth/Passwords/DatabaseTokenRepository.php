...
class DatabaseTokenRepository implements \Illuminate\Auth\Passwords\TokenRepositoryInterface
{
     ...
     */
    public function __construct(protected ConnectionInterface $connection, protected HasherContract $hasher, protected string $table, protected string $hashKey, protected int $expires = 3600, protected int $throttle = 60)
    {
    }
    /**
