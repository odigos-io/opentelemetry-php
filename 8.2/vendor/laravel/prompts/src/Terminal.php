...
class Terminal
{
    ...
    protected function queryColors(): void
    {
        ...
        fwrite(\STDOUT, "\x1b]10;?\x1b\\\x1b]11;?\x1b\\");
        fflush(\STDOUT);
        ...
        $parse = fn(array $m) => [(int) (hexdec($m[1]) / (strlen($m[1]) === 4 ? 257 : 1)), (int) (hexdec($m[2]) / (strlen($m[2]) === 4 ? 257 : 1)), (int) (hexdec($m[3]) / (strlen($m[3]) === 4 ? 257 : 1))];
